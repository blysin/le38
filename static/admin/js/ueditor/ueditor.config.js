...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       // ,imagePath:URL + "jsp/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,imageManagerPath:"/images/upload/"
        ...
        , toolbars:[["source","link", "unlink","bold","italic","underline"
            ,'directionalityltr', 'directionalityrtl', 'indent',"justifyleft", "justifycenter", "justifyright", "justifyjustify","|"
            ,"insertorderedlist","insertunorderedlist","|","insertimage","|","inserttable", "deletetable","|"
            ,'removeformat',, 'fontfamily', 'fontsize','forecolor','backcolor',"insertvideo"]]
        /*, toolbars:[
