...
(function(e) {
	e.log = function() {
		...
		var r = e.length;
		r === 1 ? console[t](e[0]) : r === 2 ? console[t](e[0], e[1])
				: r === 3 ? console[t](e[0], e[1], e[2]) : console[t](e
						.join(" "))
	}
})(seajs._util);
(function(e, t, n) {
	...
	function f(e) {
		...
		if (t === "/")
			return e;
		t === "#" ? e = e.slice(0, -1) : e.indexOf("?") === -1 && !s.test(e)
				&& (e += ".js");
	...
	function h(n) {
		...
		for (var s = 0; s < r.length; s++) {
			...
			if (e.isArray(o) && o.length === 2) {
				var f = o[0];
				if (e.isString(f) && i.indexOf(f) > -1 || e.isRegExp(f)
						&& f.test(i))
					i = i.replace(f, o[1])
			} else
	...
	function d(e, n) {
		...
		if (v(e))
			...
			g(e) ? r = n.match(o)[1] + e : r = t.base + "/" + e;
		return f(r)
	}
	function v(e) {
	...
	var r = /.*(?=\/.*$)/, i = /([^:\/])\/\/+/g, s = /\.(?:css|js)$/, o = /^(.*?\w)(?:\/|$)/, c = {}, w = n.location, E = w.protocol
			+ "//" + w.host + b(w.pathname);
...
(function(e, t) {
	...
	var n = document, r = n.head || n.getElementsByTagName("head")[0]
			|| n.documentElement, i = r.getElementsByTagName("base")[0], s = /\.css(?:\?|$)/i, o = /loaded|complete|undefined/, u, a;
	...
	e.importStyle = function(e, t) {
		...
		t && (i.id = t);
		r.appendChild(i);
		i.styleSheet ? i.styleSheet.cssText = e : i.appendChild(n
				.createTextNode(e))
	};
	var d = navigator.userAgent, v = Number(d.replace(
			/.*AppleWebKit\/(\d+)\..*/, "$1")) < 536, m = d.indexOf("Firefox") > 0
			&& !("onload" in document.createElement("link"))
})(seajs._util, seajs._config, this);
(function(e) {
	function n(e) {
		return e.replace(/^\s*\/\*[\s\S]*?\*\/\s*$/mg, "").replace(
				/^\s*\/\/.*$/mg, "")
	}
...
(function(e, t, n) {
	...
	u._define = function(e, n, i) {
		...
		!t.isArray(n) && t.isFunction(i)
				&& (n = t.parseDependencies(i.toString()));
		var a = {
			id : e,
			dependencies : n,
			factory : i
		...
		if (document.attachEvent) {
			...
			f
					|| t
							.log(
									"Failed to derive URI from interactive script for:",
									i.toString(), "warn")
		}
		var p = e ? d(e) : f;
		if (p) {
	...
	u._find = function(e) {
		var n = [];
		t.forEach(t.keys(r), function(i) {
			if (t.isString(e) && i.indexOf(e) > -1 || t.isRegExp(e)
					&& e.test(i)) {
				var s = r[i];
	...
	u._fetch = t.fetch;
	u._save = m;
	var a = {}, f = {}, l = {}, c = null, h = null, p = [], N = new u(
			t.pageUri, o.COMPILED);
	e.use = function(t, n) {
		T(function() {
			N._use(t, n)
		});
...
(function(e, t, n) {
	...
	function c(e) {
		if (e.indexOf("??") === -1)
			return e;
		var n = e.split("??"), r = n[0], i = t.filter(n[1].split(","),
				function(e) {
	...
	function h(e, n, r) {
		e
				&& e !== n
				&& t.log("The alias config is conflicted:", "key =", '"' + r
						+ '"', "previous =", '"' + e + '"', "current =", '"'
						+ n + '"', "warn")
	}
	var r = "seajs-ts=", i = r + t.now(), s = document
			.getElementById("seajsnode");
	if (!s) {
...
define("bui/common", [ "bui/ua", "bui/json", "bui/date", "bui/array",
		"bui/keycode", "bui/observable", "bui/observable", "bui/base",
		"bui/component" ], function(e) {
	var t = e("bui/util");
	t.mix(t, {
		UA : e("bui/ua"),
		JSON : e("bui/json"),
...
define(
		...
		function() {
			(function(e) {
				if (e.fn) {
					e.fn.on = e.fn.on || e.fn.bind;
					e.fn.off = e.fn.off || e.fn.unbind
				}
			})(jQuery);
			...
			$.extend(BUI, {
				...
				isObject : r.call(null) === "[object Object]" ? function(e) {
					return e !== null && e !== undefined
							&& r.call(e) === "[object Object]"
							&& e.ownerDocument === undefined
				} : function(e) {
				...
				augment : function(e, t) {
					...
					for (var n = 1; n < arguments.length; n++)
						BUI.mix(e.prototype, arguments[n].prototype
								|| arguments[n]);
					return e
				},
				...
				extend : function(e, t, n, r) {
					...
					e.prototype = BUI.mix(s, e.prototype);
				...
				substitute : function(e, t, n) {
					return !BUI.isString(e) || !BUI.isObject(t)
							&& !BUI.isArray(t) ? e : e.replace(
							n || /\\?\{([^{}]+)\}/g, function(e, n) {
				...
				isInView : function(e) {
					var t = e.left, n = e.top, r = BUI.viewportWidth(), i = BUI
							.viewportHeight(), s = BUI.scrollTop(), o = BUI
							.scrollLeft();
					return t < o || t > o + r ? !1 : n < s || n > s + i ? !1
							: !0
				},
			...
			var u = BUI.FormHelper = {
				...
				setFields : function(e, t) {
					for ( var n in t)
						t.hasOwnProperty(n)
								&& BUI.FormHelper.setField(e, n, t[n])
				},
				clear : function(e) {
					var t = $.makeArray(e.elements);
					BUI.each(t, function(e) {
						e.type === "checkbox" || e.type === "radio" ? $(e)
								.attr("checked", !1) : $(e).val("");
						$(e).change()
					})
				},
				setField : function(e, t, n) {
					var r = e.elements[t];
					BUI.isArray(r) || r && r.length ? BUI.each(r, function(e) {
						u._setFieldValue(e, n)
					}) : u._setFieldValue(r, n)
				},
				_setFieldValue : function(e, t) {
					e.type === "checkbox" ? e.value == t || BUI.isArray(t)
							&& BUI.Array.indexOf(e.value, t) !== -1 ? $(e)
							.attr("checked", !0) : $(e).attr("checked", !1)
							: e.type === "radio" ? e.value == t ? $(e).attr(
									"checked", !0) : $(e).attr("checked", !1)
									: $(e).val(t)
				},
...
define("bui/array", [ "bui/util" ], function(e) {
	...
	t.Array = {
		...
		slice : function(e, t, n) {
			return arguments.length <= 2 ? Array.prototype.slice.call(e, t)
...
define("bui/observable", [ "bui/util" ], function(e) {
	...
	t.augment(n, {
		...
		fireWith : function(e, n) {
			var r = this, i;
			t.each(r._functions, function(t) {
				i = t.apply(e, n);
				if (i === !1)
					return !1
			});
	...
	t.augment(i,
			{
				...
				clearListeners : function() {
					...
					for ( var n in t)
						t.hasOwnProperty(n) && t[n].empty()
				},
				fire : function(e, t) {
					var n = this, r = n._getCallbacks(e), i = $
							.makeArray(arguments), s;
					if (!t) {
						t = {};
						i.push(t)
					}
				...
				publish : function(e, n) {
					...
					if (n.bubbles)
						t.Array.indexOf(e, i) === -1 && i.push(e);
					else {
...
define(
		...
		function(e) {
			...
			function h(e, t) {
				...
				p && typeof p == "object" && typeof p.toJSON == "function"
						&& (p = p.toJSON(e));
				...
				case "object":
					...
					if (l && typeof l == "object") {
						...
						for (r in p)
							if (Object.hasOwnProperty.call(p, r)) {
								i = h(r, p);
								i && f.push(c(r) + (u ? ": " : ":") + i)
							}
					i = f.length === 0 ? "{}" : u ? "{\n" + u
		...
		function() {
			function t(e, n) {
				...
				if (typeof n == "undefined" || n == null || n == "") {
					var r = new Array("y-m-d", "yyyy-mm-dd",
							"yyyy-mm-dd HH:MM:ss", "H:M:s");
				...
				e += "";
				var o = 0, u = 0, a = "", f = "", l, c, h = new Date, p = h
						.getYear(), d = h.getMonth() + 1, v = 1, m = 0, g = 0, y = 0;
				...
				while (u < n.length) {
					...
					if (f == "yyyy" || f == "yy" || f == "y") {
						...
						p = this.getInt(e, o, l, c);
						if (p == null)
							return null;
						o += p.length;
						p.length == 2
								&& (p = p > 70 ? 1900 + (p - 0) : 2e3 + (p - 0))
					} else if (f == "mm" || f == "m") {
			...
			function n(e, t, n) {
				...
				case "w":
					...
					break;
				case "m":
					r = new Date(r.getFullYear(), r.getMonth() + parseInt(t), r
							.getDate(), r.getHours(), r.getMinutes(), r
							.getSeconds());
					break;
				case "y":
					r = new Date(r.getFullYear() + parseInt(t), r.getMonth(), r
							.getDate(), r.getHours(), r.getMinutes(), r
							.getSeconds())
				}
				return r
			...
			var e = /^(?:(?!0000)[0-9]{4}([-/.]+)(?:(?:0?[1-9]|1[0-2])\1(?:0?[1-9]|1[0-9]|2[0-8])|(?:0?[13-9]|1[0-2])\1(?:29|30)|(?:0?[13578]|1[02])\1(?:31))|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)([-/.]?)0?2\2(?:29))(\s+([01]|([01][0-9]|2[0-3])):([0-9]|[0-5][0-9]):([0-9]|[0-5][0-9]))?$/, r = function() {
				var e = /w{1}|d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g, t = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, n = /[^-+\dA-Z]/g, r = function(
						e, t) {
					e = String(e);
					t = t || 2;
					while (e.length < t)
					...
					dayNames : [ "Sun", "Mon", "Tue", "Wed", "Thu", "Fri",
							...
							"Thursday", "Friday", "Saturday", "星期日", "星期一",
							"星期二", "星期三", "星期四", "星期五", "星期六" ],
				...
				return function(o, u, a) {
					...
					var f = a ? "getUTC" : "get", l = o[f + "Date"](), c = o[f
							+ "Day"](), h = o[f + "Month"](), p = o[f
							+ "FullYear"](), d = o[f + "Hours"](), v = o[f
							+ "Minutes"](), m = o[f + "Seconds"](), g = o[f
							+ "Milliseconds"](), y = a ? 0 : o
							.getTimezoneOffset(), b = {
						d : l,
						dd : r(l, undefined),
						ddd : s.dayNames[c],
						...
						T : d < 12 ? "A" : "P",
						TT : d < 12 ? "AM" : "PM",
						Z : a ? "UTC" : (String(o).match(t) || [ "" ]).pop()
								.replace(n, ""),
						o : (y > 0 ? "-" : "+")
								+ r(Math.floor(Math.abs(y) / 60) * 100
										+ Math.abs(y) % 60, 4),
						S : [ "th", "st", "nd", "rd" ][l % 10 > 3 ? 0 : (l
								% 100 - l % 10 !== 10)
								* l % 10]
					};
				...
				isEquals : function(e, t) {
					return e == t ? !0 : !e || !t ? !1 : !e.getTime
							|| !t.getTime ? !1 : e.getTime() == t.getTime()
				},
...
define("bui/base", [ "bui/observable" ], function(e) {
	...
	function o(e, t, n, r, i) {
		...
		var o, u, a;
		a = e.get(t);
		if (!$.isPlainObject(n) && !BUI.isArray(n) && a === n)
			return undefined;
		if (!r.silent && !1 === s(e, "before", t, a, n))
			return !1;
		o = e._set(t, n, r);
		if (o === !1)
			return o;
	...
	BUI.augment(u, {
		...
		set : function(e, t, n) {
			...
			if ($.isPlainObject(e)) {
				...
				var i = Object(e), s = [];
				for (e in i)
					i.hasOwnProperty(e) && o(r, e, i[e], n);
				return r
			}
			return o(r, e, t, n)
		},
		...
		_initAttrs : function(e) {
			...
			if (e)
				for ( var n in e)
					e.hasOwnProperty(n) && t._set(n, e[n])
		}
	});
	return u
});
define("bui/component", [ "bui/component/manage", "bui/component/uibase",
		"bui/component/view", "bui/component/controller" ], function(e) {
	function n(e, n) {
		var r, i;
		if (e && (i = e.xclass)) {
			n && !e.prefixCls && (e.prefixCls = n.get("prefixCls"));
			r = t.Manager.getConstructorByXClass(i);
			r || BUI.error("can not find class by xclass desc : " + i);
			e = new r(e)
		}
		return e
	}
...
define("bui/component/manage", function(e) {
	...
	function s(e) {
		...
		for (var n = 0; n < t.length; n++)
			t[n] && (t[n] = this.get("prefixCls") + t[n]);
		return t.join(" ")
	}
	var t = {}, o = {}, u = {
		__instances : o,
...
(function() {
	...
	define("bui/component/uibase", [ e + "base", e + "align", e + "autoshow",
			e + "autohide", e + "close", e + "collapseable", e + "drag",
			e + "keynav", e + "list", e + "listitem", e + "mask",
			e + "position", e + "selection", e + "stdmod", e + "decorate",
			e + "tpl", e + "childcfg", e + "bindable", e + "depends" ],
			function(t) {
				var n = t(e + "base");
				BUI.mix(n, {
					Align : t(e + "align"),
...
define(
		"bui/component/uibase/base",
		[ "bui/component/manage" ],
		function(e) {
			function u(e, t) {
				...
				while (r) {
					...
					if (u = r.mixins)
						for (var f = 0; f < u.length; f++) {
							...
							if (s) {
								n != "constructor"
										&& (s.prototype.hasOwnProperty(n) ? s = s.prototype[n]
												: s = null);
								s && a.push(s)
							}
						}
					r.prototype.hasOwnProperty(t) && (o = r.prototype[t])
							&& a.push(o);
			...
			function f(e) {
				...
				while (t) {
					t.prototype.hasOwnProperty("destructor")
							&& t.prototype.destructor.apply(e);
					if (n = t.mixins)
						for (i = n.length - 1; i >= 0; i--) {
							r = n[i] && n[i].prototype.__destructor;
							r && r.apply(e)
						}
			...
			function p(e) {
				...
				for ( var o in s)
					if (s.hasOwnProperty(o)) {
						var u = n + i(o);
						(r = e[u]) && s[o].sync !== !1
								&& (t = e.get(o)) !== undefined && r.call(e, t)
					}
			}
			var t = e("bui/component/manage"), n = "_uiSet", r = "ATTRS", i = BUI.ucfirst, s = $.noop, o = e("bui/base"), d = function(
					e) {
				var t = this, n;
				o.apply(t, arguments);
			...
			BUI.augment(d, {
				create : function() {
					var e = this;
					if (!e.get("created")) {
						e.fire("beforeCreateDom");
						a(e, "createDom", "__createDom");
						e._set("created", !0);
						e.fire("afterCreateDom");
						c(e, e.get("plugins"), "createDom")
					}
					return e
				},
				render : function() {
			...
			BUI.mix(d, {
				...
				extend : function v(e, n, r) {
					...
					if (o.xclass) {
						var u = o.priority
								|| (this.priority ? this.priority + 1 : 1);
...
define(
		"bui/component/uibase/align",
		[ "bui/ua" ],
		function(e) {
			function i(e) {
				var t = e.ownerDocument, n = t.body, r, i = $(e)
						.css("position"), s = i == "fixed" || i == "absolute";
				if (!s)
					return e.nodeName.toLowerCase() == "html" ? null
							: e.parentNode;
			...
			function s(e) {
				...
				for (s = e; s = i(s);)
					if ((!t.ie || s.clientWidth != 0) && s != l && s != c
			...
			function f(e, t, n, r) {
				var i = BUI.cloneObject(e), s = {
					width : t.width,
					height : t.height
				};
				r.adjustX && i.left < n.left && (i.left = n.left);
				r.resizeWidth && i.left >= n.left && i.left + s.width > n.right
						&& (s.width -= i.left + s.width - n.right);
				r.adjustX && i.left + s.width > n.right
						&& (i.left = Math.max(n.right - s.width, n.left));
				r.adjustY && i.top < n.top && (i.top = n.top);
				r.resizeHeight && i.top >= n.top && i.top + s.height > n.bottom
						&& (s.height -= i.top + s.height - n.bottom);
				r.adjustY && i.top + s.height > n.bottom
						&& (i.top = Math.max(n.bottom - s.height, n.top));
				return BUI.mix(i, s)
			}
			function l(e, t, n) {
				var r = [];
			...
			function v(e) {
				var t = e.attr("class"), r = new RegExp("s?" + n
						+ "[a-z]{2}-[a-z]{2}", "ig"), i = r.exec(t);
				i && e.removeClass(i.join(" "))
			}
			var t = e("bui/ua"), n = "x-align-", r = window;
			h.__getOffsetParent = i;
			...
			h.prototype = {
				_uiSetAlign : function(e, t) {
					var r = "", i, s;
					if (e && e.points) {
						this.align(e.node, e.points, e.offset, e.overflow);
				...
				align : function(e, t, n, i) {
					...
					n = n && [].concat(n) || [ 0, 0 ];
					i = i || {};
					var h = this, d = h.get("el"), v = 0, m = s(d[0]), g = p(d), y = p(e), b = o(
							g, y, t, n), w = BUI.merge(g, b);
					if (m && (i.adjustX || i.adjustY)) {
						...
						if (E.adjustX || E.adjustY)
							w = f(b, g, m, E)
					}
					if (w.left != g.left) {
						h.setInternal("x", null);
						h.get("view").setInternal("x", null);
						h.set("x", w.left)
					}
					if (w.top != g.top) {
						h.setInternal("y", null);
						h.get("view").setInternal("y", null);
						h.set("y", w.top)
					}
					w.width != g.width
							&& d.width(d.width() + w.width - g.width);
					w.height != g.height
							&& d.height(d.height() + w.height - g.height);
					return h
				},
				center : function(e) {
					var t = this;
		...
		function() {
			...
			e.prototype = {
				...
				_setTrigger : function() {
					function u(t) {
						var n = e.get("curTrigger"), i = s ? $(t.currentTarget)
								: $(this), o = e.get("align");
						if (!n || n[0] != i[0]) {
							e.set("curTrigger", i);
					...
					var e = this, t = e.get("triggerEvent"), n = e
							.get("triggerHideEvent"), r = e
							.get("triggerCallback"), i = e.get("trigger"), s = e
							.get("delegateTigger"), o = $(i);
					t
							&& (s && BUI.isString(i) ? $(document).delegate(i,
									t, u) : o.on(t, u));
					n
							&& (s && BUI.isString(i) ? $(document).delegate(i,
									n, a) : o.on(n, a))
				...
				__renderUI : function() {
					...
					t && !t.node
							&& (t.node = e.get("render") || e.get("trigger"))
				}
			};
			return e
		});
	...
	r.prototype = {
		__bindUI : function() {
			...
			e.on("afterVisibleChange", function(t) {
				var n = t.newVal;
				e.get("autoHide")
						&& (n ? e._bindHideEvent() : e._clearHideEvent())
			})
		},
		handleMoveOuter : function(e) {
			var t = this, r = e.toElement || e.relatedTarget;
			!t.containsElement(r) && !n(t, r) && t.fire("autohide") !== !1
					&& t.hide()
		},
		...
		_bindHideEvent : function() {
			...
			if (r === "click")
				$(document).on("mousedown", e(t, "handleDocumentClick"));
			else {
				t.get("el").on("mouseleave", e(t, "handleMoveOuter"));
		...
		_clearHideEvent : function() {
			...
			if (r === "click")
				$(document).off("mousedown", t(e, "handleDocumentClick"));
			else {
				e.get("el").off("mouseleave", t(e, "handleMoveOuter"));
				n && $(n).off("mouseleave", t(e, "handleMoveOuter"))
			}
		}
	};
	return r
...
define(
		...
		function() {
			...
			n.ATTRS = {
				closeTpl : {
					value : '<a tabindex="0" href=\'javascript:void("关闭")\' role="button" class="'
							+ e
							+ "close"
							+ '">'
							+ '<span class="'
			...
			n.prototype = {
				_uiSetCloseable : function(e) {
					...
					if (e) {
						r || n.setInternal("closeBtn", r = t(n));
						r.appendTo(n.get("el"), undefined)
					} else
						r && r.remove()
				}
			};
			...
			r.prototype = {
				_uiSetCloseable : function(e) {
					var t = this;
					if (e && !t.__bindCloseEvent) {
						t.__bindCloseEvent = 1;
						t.get("closeBtn").on("click", function(e) {
							t.fire("closeclick", {
								domTarget : e.target
							}) !== !1 && t.close();
							e.preventDefault()
...
define(
		...
		function() {
			...
			var n = '<div id="'
					+ e
					+ '" style="background-color: red; position: fixed; left: 0px; width: 100%; height: 100%; top: 0px; cursor: move; z-index: 999999; display: none; "></div>';
			t.prototype = {
				__bindUI : function() {
					function r(n) {
						var r = e.get("draging");
						if (r) {
							n.preventDefault();
							e._dragMoveTo(n.pageX, n.pageY, r, t)
						}
					}
					function i(t) {
						if (t.which == 1) {
					...
					var e = this, t = e.get("constraint"), n = e
							.get("dragNode");
					if (!n)
						return;
				...
				_dragMoveTo : function(e, t, n, i) {
					var s = this, o = s.get("dragBackEl"), n = n
							|| s.get("draging"), u = n.startX - e, a = n.startY
							- t;
					o.length || (o = r());
					o.css({
						cursor : "move",
					...
					s.set("xy", [ s._getConstrainX(n.elX - u, i),
							s._getConstrainY(n.elY - a, i) ])
				},
				_getConstrainX : function(e, t) {
					var n = this, r = n.get("el").outerWidth(), i = e + r, s = n
							.get("x");
					if (t) {
						var o = t.offset();
						return o.left >= e ? o.left
								: o.left + t.width() < i ? o.left + t.width()
										- r : e
					}
					return BUI.isInHorizontalView(e)
							&& BUI.isInHorizontalView(i) ? e : s
				},
				_getConstrainY : function(e, t) {
					var n = this, r = n.get("el").outerHeight(), i = e + r, s = n
							.get("y");
					if (t) {
						var o = t.offset();
						return o.top > e ? o.top
								: o.top + t.height() < i ? o.top + t.height()
										- r : e
					}
					return BUI.isInVerticalView(e) && BUI.isInVerticalView(i) ? e
							: s
				}
			};
			return t
		...
		function(e) {
			...
			i.prototype = {
				...
				_uiSetAllowKeyNav : function(e) {
					...
					e ? s.on(i, n(t, "_handleKeyDown")) : s.off(i, r(t,
							"_handleKeyDown"))
				},
				_handleKeyDown : function(e) {
					var n = this, r = n.get("ignoreInputFields"), i = e.which;
					if (r && $(e.target).is("input,select,textarea"))
						return;
					e.preventDefault();
					switch (i) {
					case t.UP:
		...
		function(e) {
			...
			function u(e) {
				var t = $(
						'<div  style="width:'
								...
								+ e
								+ '">'
								+ (r ? '<iframe style="position:absolute;left:0;top:0;background:white;width: expression(this.parentNode.offsetWidth);height: expression(this.parentNode.offsetHeight);filter:alpha(opacity=0);z-index:-1;"></iframe>'
										: "") + "</div>").prependTo("body");
			...
			a.prototype = {
				_maskExtShow : function() {
					var e = this, t, r = i(e), s = n[r], o = e
							.get("maskShared"), a = e.get("maskNode");
					if (!a) {
						if (o)
							if (s)
								a = s.node;
				...
				_maskExtHide : function() {
					var e = this, t = i(e), r = n[t], s = e.get("maskShared"), o = e
							.get("maskNode");
					if (s && r) {
						r.num = Math.max(r.num - 1, 0);
						r.num == 0 && o.hide()
					} else
						o && o.hide()
				},
				__destructor : function() {
					var e = this, t = e.get("maskShared"), n = e
							.get("maskNode");
					e.get("maskNode")
							&& (t ? e.get("visible") && e._maskExtHide() : n
									.remove())
				}
			};
			f.ATTRS = {
...
define("bui/component/uibase/decorate", [ "bui/array", "bui/json",
		"bui/component/manage" ], function(e) {
	function s(e, t) {
		if (t[e])
			return !0;
		var n = new RegExp("^" + i);
	...
	function f(e, t) {
		...
		for (r in t)
			if (!(r in s)) {
				i = t[r];
				BUI.isFunction(i) ? n.setInternal(r, i.call(n, e))
						: typeof i == "string" ? n.setInternal(r, e.find(i))
								: BUI.isArray(i) && i[0]
										&& n.setInternal(r, e.find(i[0]))
			}
	}
	function l(e, t) {
	...
	function c(e) {
		...
		if (n) {
			n = $(n);
			t.setInternal("el", n);
			t.setInternal("srcNode", n);
			r = t.get("userConfig");
			i = t.getDecorateConfig(n);
			a(e, i);
			t.get("isDecorateChild") && t.decorateInternal
					&& t.decorateInternal(n);
			l(e, n)
		}
	}
	function h() {
	...
	FIELD_CFG = i + "cfg", PARSER = "PARSER",
			Manager = e("bui/component/manage"), regx = /^[\{\[]/;
	h.ATTRS = {
		srcNode : {
			view : !0
		},
	...
	h.prototype = {
		getDecorateConfig : function(e) {
			if (!e.length)
				return null;
			var t = this, n = e[0], r = n.attributes, o = t
					.get("decorateCfgFields"), a = {};
		...
		findXClassByNode : function(e, t) {
			var n = this, i = e.attr("class") || "", s = n
					.get("defaultChildClass");
			i = i.replace(new RegExp("\\b" + r, "ig"), "");
			var o = Manager.getConstructorByXClass(i)
					|| Manager.getConstructorByXClass(s);
			if (!o && !t) {
				BUI.log(e);
				BUI.error("can not find ui " + i + " from this markup")
			}
			return Manager.getXClassByConstructor(o)
		},
...
define("bui/component/uibase/tpl", function() {
	...
	e.prototype = {
		__renderUI : function() {
			...
			if (t) {
				n = e.get("el").find(t);
				n.length && e.set("contentEl", n)
			}
		},
		getTpl : function(e) {
			var t = this, n = t.get("tpl"), r = t.get("tplRender");
			e = e || t.getAttrVals();
			return r ? r(e) : n ? BUI.substitute(n, e) : ""
		},
		setTplContent : function(e) {
			var t = this, n = t.get("el"), r = t.get("content"), i = t
					.getTpl(e);
			if (!r && i) {
				n.empty();
				n.html(i)
...
define("bui/component/uibase/list", [ "bui/component/uibase/selection" ],
		function(e) {
			...
			function i(e, t) {
				var n = t.isController ? t.getAttrVals() : t, r = e
						.get("itemTpl"), i = e.get("itemStatusCls"), o = e
						.get("itemTplRender");
				r && !n.tpl && s(t, "tpl", r);
			...
			o.ATTRS = BUI.merge(!0, n.ATTRS, t.ATTRS, {
				items : {
					sync : !1
				},
				autoInitItems : {
			...
			BUI.augment(o, n, t, {
				...
				__bindUI : function() {
					...
					e.on(t, function(t) {
						var n = t.target;
						n.get("selectable")
								&& (n.get("selected") ? e.get("multipleSelect")
										&& e.clearSelected(n) : e
										.setSelected(n))
					});
				...
				updateItem : function(e) {
					var t = this, n = t.get("idField"), r = t.findItemByField(
							n, e[n]);
					r && r.setTplContent();
					return r
				},
				removeItem : function(e) {
					...
					e instanceof BUI.Component.Controller
							|| (e = t.findItemByField(n, e[n]));
				...
				findItemByField : function(e, t, n) {
					...
					$(i).each(
							function(n, i) {
								i.get(e) == t ? s = i
										: i.get("children").length
												&& (s = r.findItemByField(e, t,
														i));
								if (s)
									return !1
							});
...
define("bui/component/uibase/depends", [ "bui/component/manage" ], function(e) {
	...
	function i(e, t, n) {
		...
		s
				&& n
				&& o
				&& (BUI.isFunction(n) ? u = n : BUI.isArray(n)
						&& (u = function() {
...
define(
		"bui/component/view",
		[ "bui/component/manage", "bui/component/uibase" ],
		function(e) {
			var t = window, n = e("bui/component/manage"), r = e("bui/component/uibase"), i = document, s = r
					.extend(
							[ r.TplView ],
							{
								getComponentCssClassWithState : function(e) {
									...
									e = e || "";
									return t.getCssClassWithPrefix(n.split(
											/\s+/).join(e + " ")
											+ e)
								},
								...
								renderUI : function() {
									var e = this;
									if (!e.get("srcNode")) {
										var t = e.get("render"), n = e
												.get("el"), r = e
												.get("elBefore");
										r ? n.insertBefore(r, undefined)
												: t ? n.appendTo(t, undefined)
														: n.appendTo(i.body,
																undefined)
									}
								},
								createDom : function() {
									var e = this, t = e.get("contentEl"), n = e
											.get("el");
									if (!e.get("srcNode")) {
										n = $("<" + e.get("elTagName") + ">");
										t && n.append(t);
								...
								_uiSetHighlighted : function(e) {
									var t = this, n = t.getStatusCls("hover"), r = t
											.get("el");
									r[e ? "addClass" : "removeClass"](n)
								},
								_uiSetDisabled : function(e) {
									var t = this, n = t
											.getStatusCls("disabled"), r = t
											.get("el");
									r[e ? "addClass" : "removeClass"](n).attr(
											"aria-disabled", e);
									e && t.get("highlighted")
											&& t.set("highlighted", !1);
									t.get("focusable")
											&& t.getKeyEventTarget().attr(
													"tabIndex", e ? -1 : 0)
								},
								_uiSetActive : function(e) {
									var t = this, n = t.getStatusCls("active");
									t.get("el")[e ? "addClass" : "removeClass"]
											(n).attr("aria-pressed", !!e)
								},
								_uiSetFocused : function(e) {
									var t = this, n = t.get("el"), r = t
											.getStatusCls("focused");
								...
								_uiSetVisible : function(e) {
									var t = this, n = t.get("el"), r = t
											.get("visibleMode");
									r === "visibility" ? n.css("visibility",
											e ? "visible" : "hidden") : n.css(
											"display", e ? "" : "none")
								},
								destructor : function() {
									var e = this.get("el");
...
define("bui/component/loader", [ "bui/util" ], function(e) {
	...
	t.augment(r, {
		...
		load : function(e) {
			var n = this, r = n.get("url"), i = n.get("ajaxOptions"), s = n
					.get("lastParams"), o = n.get("appendParams");
			e = e || s;
			e = t.merge(o, e);
			n.set("lastParams", e);
			if (!r)
		...
		onload : function(e, t) {
			var n = this, r = n.get("loadMask"), i = n.get("property"), s = n
					.get("callback"), o = n.get("renderer"), u = n
					.get("target");
			u.set(i, o.call(n, e));
			r && r.hide && r.hide();
			s && s.call(this, e, t)
...
define(
		...
		[ "bui/component/uibase", "bui/component/manage", "bui/component/view",
		...
		function(e) {
			...
			function l(e) {
				...
				for (r in t)
					if (t.hasOwnProperty(r)) {
						n = t[r];
						if (n.view) {
							(s = e.get(r)) !== undefined && (i[r] = s);
							e.on("after" + BUI.ucfirst(r) + "Change", u(r));
							n.getter = a(r)
						}
					}
				delete i.autoRender;
			...
			var t = e("bui/component/uibase"), n = e("bui/component/manage"), r = e("bui/component/view"), i = e("bui/component/loader"), s = BUI.wrapBehavior, o = BUI.getWrapBehavior, p = t
					.extend(
							[ t.Decorate, t.Tpl, t.ChildCfg, t.KeyNav,
									t.Depends ],
							{
								isController : !0,
								getCssClassWithPrefix : n.getCssClassWithPrefix,
								initializer : function() {
									var e = this;
									e.get("id")
											|| e.set("id", e.getNextUniqueId());
									n.addComponent(e.get("id"), e);
									e.setInternal("view", l(e))
								},
								getNextUniqueId : function() {
									var e = this, t = n
											.getXClassByConstructor(e.constructor);
									return BUI.guid(t)
								},
								createDom : function() {
								...
								containsElement : function(e) {
									...
									if (!t.get("rendered"))
										return !1;
									$.contains(n[0], e) || n[0] === e ? i = !0
											: BUI.each(r, function(t) {
												if (t.containsElement(e)) {
													i = !0;
													return !1
												}
											});
								...
								_uiSetFocusable : function(e) {
									...
									if (e)
										r.attr("tabIndex", 0).attr("hideFocus",
												!0).on("focus",
												s(t, "handleFocus")).on("blur",
												s(t, "handleBlur")).on(
												"keydown",
												s(t, "handleKeydown")).on(
												"keyup", s(t, "handleKeyUp"));
									else {
								...
								_uiSetHandleMouseEvents : function(e) {
									...
									if (e)
										n.on("mouseenter",
												s(t, "handleMouseEnter")).on(
												"mouseleave",
												s(t, "handleMouseLeave")).on(
												"contextmenu",
												s(t, "handleContextMenu")).on(
												"mousedown",
												s(t, "handleMouseDown")).on(
												"mouseup",
												s(t, "handleMouseUp")).on(
												"dblclick",
												s(t, "handleDblClick"));
									else {
										r = o(t, "handleMouseEnter")
												&& n.off("mouseenter", r);
										r = o(t, "handleMouseLeave")
												&& n.off("mouseleave", r);
										r = o(t, "handleContextMenu")
												&& n.off("contextmenu", r);
										r = o(t, "handleMouseDown")
												&& n.off("mousedown", r);
										r = o(t, "handleMouseUp")
												&& n.off("mouseup", r);
										r = o(t, "handleDblClick")
												&& n.off("dblclick", r)
									}
								},
								_uiSetFocused : function(e) {
								...
								remove : function(e) {
									...
									n ? n.removeChild(t, e) : e && t.destroy();
									return t
								},
								removeChild : function(e, t) {
									var n = this, r = n.get("children"), i = BUI.Array
											.indexOf(e, r);
									if (i === -1)
										return;
									n.fire("beforeRemoveChild", {
										child : e,
										destroy : t
									});
									i !== -1 && r.splice(i, 1);
								...
								handleDblClick : function(e) {
									...
									this.isChildrenElement(e.target)
											|| this.fire("dblclick", {
												domTarget : e.target,
												domEvent : e
											})
								...
								handleMouseDown : function(e) {
									...
									if (r) {
										...
										if (!t.get("allowTextSelection")) {
											n = e.target.nodeName;
											n = n && n.toLowerCase();
											n !== "input" && n !== "textarea"
													&& e.preventDefault()
										}
										t.isChildrenElement(e.target)
												|| t.fire("mousedown", {
													domTarget : e.target,
													domEvent : e
												})
								...
								handleMouseUp : function(e) {
									var t = this, n = t
											.isChildrenElement(e.target);
									if (t.get("active") && e.which === 1) {
										t.performActionInternal(e);
										t.set("active", !1);
										n || t.fire("click", {
											domTarget : e.target,
											domEvent : e
								...
								destructor : function() {
									var e = this, t, r, i, s = e
											.get("children");
									t = e.get("id");
									for (r = 0; r < s.length; r++)
										s[r].destroy && s[r].destroy();
									e.get("view").destroy();
									n.removeComponent(t)
								}
							},
							{
								ATTRS : {
									...
									loader : {
										getter : function(e) {
											...
											if (e && !e.isLoader) {
												e.target = t;
												n = t.get("defaultLoaderCfg");
												e = new i(BUI.merge(n, e));
												t.setInternal("loader", e)
											}
											return e
										}
									},
								...
								PARSER : {
									visible : function(e) {
										var t = this, n = e.css("display"), r = e
												.css("visibility"), i = t
												.get("visibleMode");
										return n == "none" && i == "display"
												|| r == "hidden"
												&& i == "visibility" ? !1 : !0
									}
								}
...
(function() {
	var e = "bui/data/";
	define("bui/data", [ "bui/common", e + "sortable", e + "proxy",
			e + "abstractstore", e + "store", e + "node", e + "treestore" ],
			function(t) {
	...
	n.ATTRS = {
		compareFunction : {
			value : function(e, t) {
				e === undefined && (e = "");
				t === undefined && (t = "");
				return BUI.isString(e) ? e.localeCompare(t) : e > t ? 1
						: e === t ? 0 : -1
			}
		},
		sortField : {},
	...
	BUI.augment(n, {
		compare : function(t, n, r, i) {
			...
			if (!r || !i)
				return 1;
			o = i === e ? 1 : -1;
			return s.get("compareFunction")(t[r], n[r]) * o
		},
		...
		function(e) {
			...
			BUI.augment(r, {
				_processParams : function(e) {
					var t = this, n = t.get("pageStart"), r = [ "start",
							"limit", "pageIndex" ];
					e.pageIndex != null && (e.pageIndex = e.pageIndex + n);
			...
			BUI
					.augment(
							...
							{
								_read : function(e, t) {
									var n = this, r = e.pageable, i = e.start, s = e.sortField, o = e.sortDirection, u = e.limit, a = n
											.get("data"), f = [];
									a = n._getMatches(e);
									n.sortData(s, o);
									if (u) {
								...
								_getMatches : function(e) {
									var t = this, n = t.get("matchFields"), r, i = t
											.get("data")
											|| [];
									if (e && n.length) {
										r = t._getMatchFn(e, n);
										i = BUI.Array.filter(i, r)
									}
									return i
								}
							});
...
define("bui/data/abstractstore", [ "bui/common", "bui/data/proxy" ],
		function(e) {
			...
			r.ATTRS = {
				...
				url : {},
				events : {
					value : [ "acceptchanges", "load", "beforeload",
							"beforeprocessload", "add", "exception", "remove",
							"update", "localsort" ]
				},
				data : {
					setter : function(e) {
			...
			t.augment(r, {
				...
				_initProxy : function() {
					...
					if (!(r instanceof n)) {
						t && (r.url = t);
						r.type === "ajax" || r.url ? r = new n.Ajax(r)
								: r = new n.Memery(r);
						e.set("proxy", r)
					}
				},
				...
				processLoad : function(e, t) {
					...
					n.fire("beforeprocessload", {
						data : e
					});
					n.fire("beforeProcessLoad", e);
					if (e[r] || e.exception) {
						n.onException(e);
						return !1
					}
...
define(
		"bui/data/treestore",
		[ "bui/common", "bui/data/node", "bui/data/abstractstore",
				"bui/data/proxy" ],
		function(e) {
			function s(e) {
			...
			t
					.augment(
							s,
							{
								...
								_initData : function() {
									var e = this, t = e.get("autoLoad"), n = e
											.get("pidField"), r = e
											.get("proxy"), i = e.get("root");
									!r.get("url") && n
											&& r.get("matchFields").push(n);
									t && !i.children && e.loadNode(i)
								},
								initRoot : function() {
									var e = this, t = e.get("map"), r = e
											.get("root");
									r || (r = {});
								...
								remove : function(e) {
									var n = e.parent || _self.get("root"), r = t.Array
											.indexOf(e, n.children);
									t.Array.remove(n.children, e);
								...
								setResult : function(e) {
									var t = this, n = t.get("proxy"), i = t
											.get("root");
									if (n instanceof r.Memery) {
										t.set("data", e);
										t.load({
											id : i.id
										})
								...
								afterProcessLoad : function(e, n) {
									var r = this, i = r.get("pidField"), s = n.id
											|| n[i], o = r.get("dataProperty"), u = r
											.findNode(s)
											|| r.get("root");
									t.isArray(e) ? r.setChildren(u, e) : r
											.setChildren(u, e[o]);
									u.loaded = !0;
									r.fire("load", {
										node : u,
								...
								hasData : function() {
									return this.get("root").children
											&& this.get("root").children.length !== 0
								},
								isLoaded : function(e) {
									var t = this.get("root");
									return e == t && !t.children ? !1 : !this
											.get("url")
											&& !this.get("pidField") ? !0
											: e.loaded || e.leaf || e.children
													&& e.children.length
								},
								loadNode : function(e) {
									var t = this, n = t.get("pidField"), r;
									if (t.isLoaded(e))
										return;
									r = {
										id : e.id
...
define(
		"bui/data/store",
		[ "bui/data/proxy", "bui/data/abstractstore", "bui/data/sortable" ],
		function(e) {
			function i(e, t) {
				if (e < 0)
					return;
			...
			var t = e("bui/data/proxy"), n = e("bui/data/abstractstore"), r = e("bui/data/sortable"), u = function(
					e) {
					...
					.augment(
							u,
							{
								...
								getTotalCount : function() {
									var e = this, t = e.get("resultMap"), n = e
											.get("totalProperty");
									return t[n] || 0
								},
								getResult : function() {
								...
								remove : function(e, t) {
									...
									BUI.isArray(e) || (e = [ e ]);
									$.each(e, function(e, r) {
										var e = n.findIndexBy(r, t), u = i(e, n
												.getResult());
										!o(u, n.get("newRecords"))
												&& !o(u, n
														.get("deletedRecords"))
												&& n.get("deletedRecords")
														.push(u);
								...
								sort : function(e, t) {
									...
									if (!r)
										...
										n.set("sortField", e);
										n.set("sortDirection", t);
										n.load(n.get("sortInfo"))
									}
								},
								sum : function(e, t) {
								...
								setValue : function(e, t, n) {
									var r = e, i = this;
									r[t] = n;
									!o(r, i.get("newRecords"))
											&& !o(r, i.get("modifiedRecords"))
											&& i.get("modifiedRecords").push(r);
									i.fire("update", {
										record : r,
										field : t,
										value : n
								...
								update : function(e, t) {
									...
									if (t) {
										i = r._getDefaultMatch();
										s = r.findIndexBy(e, i);
										s >= 0 && (n = r.getResult()[s])
									}
									n = BUI.mix(n, e);
									!o(n, r.get("newRecords"))
											&& !o(n, r.get("modifiedRecords"))
											&& r.get("modifiedRecords").push(n);
									r.fire("update", {
										record : n
									})
								},
								...
								_getPageParams : function() {
									var e = this, t = e.get("sortInfo"), n = e
											.get("start"), r = e
											.get("pageSize"), i = e
											.get("pageIndex")
											|| (r ? n / r : 0);
								...
								afterProcessLoad : function(e, t) {
									var n = this, r = n.get("root"), i = t.start, s = t.limit, o = n
											.get("totalProperty");
									BUI.isArray(e) ? n._setResult(e) : n
											._setResult(e[r], e[o]);
									n.set("start", i);
...
define("bui/overlay", [ "bui/common", "bui/overlay/overlay",
		"bui/overlay/dialog", "bui/overlay/message" ], function(e) {
...
define(
		...
		[ "bui/common" ],
		function(e) {
			var t = e("bui/common"), n = t.Component, r = "x-align-arrow", i = n.UIBase, s = n.View
					.extend([ i.PositionView, i.CloseView ]), o = n.Controller
					.extend(
							[ i.Position, i.Align, i.Close, i.AutoShow,
									i.AutoHide ],
							{
								renderUI : function() {
									var e = this, t = e.get("el"), n = e
											.get("arrowContainer"), r = n ? t
											.one(n) : t;
									e.get("showArrow")
											&& $(e.get("arrowTpl")).appendTo(r)
								},
								show : function() {
									function o() {
										r === "visibility" ? n.css({
									...
									var e = this, t = e.get("effect"), n = e
											.get("el"), r = e
											.get("visibleMode"), i = t.effect, s = t.duration;
									if (!e.get("rendered")) {
										e.set("visible", !0);
										e.render();
										e.set("visible", !1);
								...
								hide : function() {
									...
									var e = this, t = e.get("effect"), n = e
											.get("el"), r = t.effect, i = t.duration;
									switch (r) {
									case "linear":
										n.hide(i, s);
										break;
...
define(
		...
		[ "bui/overlay/overlay" ],
		function(e) {
			var t = e("bui/overlay/overlay"), n = BUI.Component.UIBase, r = "header-title", i = BUI.prefix, s = 20, o = t.View
					.extend([ n.StdModView, n.MaskView ], {
						_uiSetTitle : function(e) {
							var t = this, n = t.get("el");
							n.find("." + r).html(e)
						},
						_uiSetContentId : function(e) {
							var t = this, n = t.get("body"), r = $("#" + e)
									.children();
							r.appendTo(n)
						},
						_uiSetHeight : function(e) {
							var t = this, n = e, r = t.get("header"), i = t
									.get("body"), o = t.get("footer");
							n -= r.outerHeight() + o.outerHeight();
							n -= s * 2;
							i.height(n)
						},
						_removeContent : function() {
							var e = this, t = e.get("body"), n = e
									.get("contentId");
							n ? t.children().appendTo($("#" + n)) : t
									.children().remove()
						}
					}, {
						xclass : "dialog-view"
					...
					.extend(
							[ n.StdMod, n.Mask, n.Drag ],
							{
								...
								_createButton : function(e, t) {
									var n = this, r = '<button class="'
											+ e.elCls + '">' + e.text
											+ "</button>", i = $(r).appendTo(t);
									i.on("click", function() {
										e.handler.call(n, n, this)
									})
								},
								destructor : function() {
									var e = this, t = e.get("contentId"), n = e
											.get("body"), r = e
											.get("closeAction");
									if (r == "destroy") {
										e.hide();
										t && n.children().appendTo("#" + t)
									}
								}
							},
							{
								ATTRS : {
									closeTpl : {
										...
										value : '<a tabindex="0" href=javascript:void("关闭") role="button" class="'
												+ i
												+ 'ext-close" style=""><span class="'
												+ i
												+ 'ext-close-x x-icon x-icon-normal">×</span></a>'
									},
									buttons : {
										value : [
												{
...
define("bui/overlay/message", [ "bui/overlay/dialog" ], function(e) {
	...
	var t = e("bui/overlay/dialog"), n = BUI.prefix, r = {
		...
		_setContent : function() {
			var e = this, t = e.get("body"), n = BUI.substitute(e
					.get("contentTpl"), {
				msg : e.get("msg"),
		...
		ATTRS : {
			...
			iconTpl : {
				getter : function() {
					...
					return '<div class="x-icon x-icon-' + t + '">' + r[t]
							+ "</div>"
				}
			},
			contentTpl : {
				value : '{iconTpl}<div class="' + n
						+ 'message-content">{msg}</div>'
			}
		}
	}, {
		xclass : "message",
...
(function() {
	var e = "bui/list/";
	define("bui/list", [ "bui/common", e + "list", e + "listitem",
			e + "simplelist", e + "listbox" ], function(t) {
...
define(
		...
		function(e) {
			...
			o.prototype = {
				clearControl : function() {
					var e = this, t = e.getItemContainer(), n = e
							.get("itemCls");
					t.find("." + n).remove()
				},
				...
				getItemTpl : function(e, n) {
					var r = this, i = r.get("itemTplRender"), s = r
							.get("itemTpl");
					return i ? i(e, n) : t.substitute(s, e)
				},
				_createItem : function(e, t) {
					var n = this, r = n.getItemContainer(), i = n
							.get("itemCls"), s = n.get("dataField"), o = n
							.getItemTpl(e, t), u = $(o);
					if (t !== undefined) {
						var a = r.find("." + i)[t];
				...
				setItemStatusCls : function(e, t, n) {
					var r = this, i = r.getItemStatusCls(e), s = n ? "addClass"
							: "removeClass";
					t && $(t)[s](i)
				},
				...
				getSelectedElements : function() {
					var e = this, t = e.getItemStatusCls("selected"), n = e
							.get("el");
					return n.find("." + t)
				},
			...
			a.ATTRS = t.merge(!0, i.ATTRS, n.ATTRS, {
				dataField : {
					view : !0,
					value : "data-item"
				},
			...
			a.PARSER = {
				items : function(e) {
					var n = this, r = [], i = n.get("itemCls"), s = n
							.get("dataField"), o = e.find("." + i);
					if (!o.length) {
						o = e.children();
						o.addClass(i)
					}
			...
			t
					.augment(
							...
							n,
							{
								_uiSetItems : function(e) {
									var t = this;
									if (t.get("srcNode") && !t.get("rendered"))
										return;
									this.setItems(e)
								},
								__bindUI : function() {
									function i(t, n) {
										...
										if (!i) {
											r || e.clearSelected();
											e.setItemSelected(t, !0, n)
										} else
											r && e.setItemSelected(t, !1, n)
									}
									var e = this, t = e.get("selectedEvent"), n = e
											.get("itemCls"), r = e.get("view")
											.getItemContainer();
									r.delegate("." + n, "click", function(n) {
										var r = $(n.currentTarget), s = e
												.getItemByElement(r);
										if (e.isItemDisabled(s, r))
											return;
								...
								getItemText : function(e) {
									...
									return e ? n ? n(e) : $(t.findElement(e))
											.text() : ""
								},
								removeItem : function(e) {
									var n = this, r = n.get("items"), i = n
											.findElement(e), s;
								...
								addItemToView : function(e, t) {
									var n = this, r = n.get("view").addItem(e,
											t);
									n.fire("itemrendered", {
										item : e,
										domTarget : $(r)[0],
								...
								updateItem : function(e) {
									var t = this, n = t.get("view").updateItem(
											e);
									t.fire("itemupdated", {
										item : e,
										domTarget : $(n)[0],
								...
								findElement : function(e) {
									var n = this;
									t.isString(e) && (e = n.getItem(e));
									return this.get("view").findElement(e)
								},
								...
								isItemSelected : function(e, t) {
									var n = this;
									t = t || n.findElement(e);
									return n.get("view").isElementSelected(t)
								},
								...
								getSelection : function() {
									var e = this, n = e.get("view")
											.getSelectedElements(), r = [];
									t.each(n, function(t) {
										r.push(e.getItemByElement(t))
									});
									return r
								...
								hasStatus : function(e, t, n) {
									...
									n = n || r.findElement(e);
									return r.get("view").hasStatus(t, n)
								},
								setItemStatus : function(e, t, n, r) {
									var i = this;
									e && (r = r || i.findElement(e));
									if (!i.isItemDisabled(e, r)
											|| t === "disabled") {
										if (e) {
											t === "disabled" && n
													&& i.clearItemStatus(e);
											i.setStatusValue(e, t, n);
											i.get("view").setItemStatusCls(t,
													r, n);
											i.fire("itemstatuschange", {
												item : e,
												status : t,
												value : n,
												element : r
								...
								clearItemStatus : function(e, n, r) {
									...
									if (n)
										...
										s.selected || i.setItemSelected(e, !1);
										i.setItemStatus(e, "hover", !1)
									}
								}
							});
			a.View = o;
...
define("bui/list/keynav", function() {
	...
	BUI.augment(e, {
		setHighlighted : function(e, t) {
			if (this.hasStatus(e, "hover", t))
				return;
			var n = this, r = n.get("highlightedStatus"), i = n
					._getHighLightedElement(), s = i ? n.getItemByElement(i)
					: null;
			if (s !== e) {
				s && this.setItemStatus(s, r, !1, i);
				this.setItemStatus(e, r, !0, t)
			}
		},
		_getHighLightedElement : function() {
			var e = this, t = e.get("highlightedStatus"), n = e.get("view")
					.getFirstElementByStatus(t);
			return n
		},
		...
		getRowCount : function(e) {
			var t = this;
			e = e || t.getColumnCount();
			return (this.getCount() + e - 1) / e
		},
		_getNextItem : function(e, t, n) {
			var r = this, i = r._getCurrentIndex(), s = r.getCount(), o = e ? 1
					: -1, u;
			if (i === -1)
				return e ? r.getFirstItem() : r.getLastItem();
			e || (t *= o);
			u = (i + t + n) % n;
			u > s - 1 && (e ? u -= s - 1 : u += t);
			return r.getItemAt(u)
		},
...
define(
		"bui/list/simplelist",
		[ "bui/common", "bui/list/domlist", "bui/list/keynav" ],
		function(e) {
			var t = e("bui/common"), n = t.Component.UIBase, r = e("bui/list/domlist"), i = e("bui/list/keynav"), s = t.prefix
					+ "list-item", o = t.Component.View.extend([ r.View ], {
				...
				bindUI : function() {
					var e = this, t = e.get("itemCls"), n = e.get("view")
							.getItemContainer();
					n.delegate(
							"." + t,
							"mouseover",
							function(t) {
								var n = t.currentTarget, r = e
										.getItemByElement(n);
								if (e.isItemDisabled(t.item, t.currentTarget))
									return;
								e.get("highlightedStatus") === "hover" ? e
										.setHighlighted(r, n) : e
										.setItemStatus(r, "hover", !0, n)
...
define("bui/list/list", function(e) {
	var t = BUI.Component, n = t.UIBase, r = t.Controller.extend(
			[ n.ChildList ], {}, {
				ATTRS : {
					elTagName : {
						view : !0,
...
define("bui/picker", [ "bui/common", "bui/picker/picker",
		"bui/picker/listpicker" ], function(e) {
...
define("bui/picker/picker", [ "bui/overlay" ], function(e) {
	var t = e("bui/overlay").Overlay, n = t.extend(
			{
				bindUI : function() {
					var e = this, t = e.get("innerControl"), n = e
							.get("hideEvent"), r = $(e.get("trigger"));
					r.on(e.get("triggerEvent"), function(t) {
						if (e.get("autoSetValue")) {
							var n = e.get("valueField") || e.get("textField")
									|| this, r = $(n).val();
							e.setSelectedValue(r)
						}
					});
					t.on(e.get("changeEvent"), function(t) {
						var n = e.get("curTrigger"), i = e.get("textField")
								|| n || r, s = e.get("valueField"), o = e
								.getSelectedValue(), u = !1;
						if (i) {
		...
		function(e) {
			var t = e("bui/list"), n = e("bui/picker/picker"), r = n.extend({
				...
				setSelectedValue : function(e) {
					...
					if (e !== r && n.getCount()) {
						n.get("multipleSelect") && n.clearSelection();
						n.setSelectionByField(e.split(","))
					}
				},
				onChange : function(e, t, n) {
					var r = this, i = r.get("curTrigger");
...
(function() {
	var e = "bui/form/";
	define("bui/form", [ "bui/common", e + "fieldcontainer", e + "form",
			e + "row", e + "fieldgroup", e + "horizontal", e + "rules",
			e + "field", e + "fieldgroup" ], function(t) {
...
define(
		...
		function(e) {
			var t = e("bui/common"), n = t.prefix, r = e("bui/overlay").Overlay, i = "data-tip", s = n
					+ "form-tip-container", o = r
					.extend(
							{
								initializer : function() {
			...
			t.augment(u, {
				_init : function() {
					...
					if (n.length) {
						t.each($.makeArray(n[0].elements), function(t) {
							var n = $(t).attr(i);
...
define(
		"bui/form/basefield",
		[ "bui/common", "bui/form/tips", "bui/form/valid", "bui/form/remote" ],
		function(e) {
			var t = e("bui/common"), n = t.Component, r = e("bui/form/tips").Item, i = e("bui/form/valid"), s = e("bui/form/remote"), o = t.prefix
					+ "form-field-error", u = "data-error", a = n.View.extend([
					s.View, i.View ], {
				renderUI : function() {
					var e = this, t = e.get("control");
					if (!t) {
						var n = e.get("controlTpl"), r = e
								.getControlContainer();
						if (n) {
							var t = $(n).appendTo(r);
							e.set("control", t)
						...
						e.set("controlContainer", t.parent())
				},
				...
				showError : function(e, n) {
					var r = this, i = r.get("control"), s = t.substitute(n, {
						error : e
					}), u = $(s);
					u.appendTo(i.parent());
					r.set("msgEl", u);
				...
				getControlContainer : function() {
					var e = this, n = e.get("el"), r = e
							.get("controlContainer");
					r && t.isString(r) && (r = n.find(r));
					return r && r.length ? r : n
				},
				...
				ATTRS : {
					...
					.extend(
							[ s, i ],
							{
								...
								bindUI : function() {
									var e = this, t = e.get("validEvent"), n = e
											.get("changeEvent"), r = e
											.get("firstValidEvent"), i = e
											.getInnerControl();
									i.is("select") && (t = "change");
									i.on(t, function() {
								...
								onValid : function() {
									...
									t = e.parseValue(t);
									if (!e.isCurrentValue(t)) {
										e.setInternal("value", t);
										e.onChange()
									}
								},
								onChange : function() {
								...
								getRemoteParams : function() {
									var e = this, t = {};
									t[e.get("name")] = e.getControlValue();
									return t
								},
								...
								validControl : function(e) {
									var t = this, n;
									e = e || t.getControlValue(), preError = t
											.get("error");
									n = t.getValidError(e);
								...
								setInnerWidth : function(e) {
									var t = this, n = t.getInnerControl(), r = n
											.outerWidth()
											- n.width();
									n.width(e - r)
								},
							...
							},
							{
								...
								PARSER : {
									...
									value : function(e) {
										var t = this, n = "select,input,textarea", r = t
												.get("value");
										if (!r)
											if (e.is(n)) {
												r = e.val();
...
define("bui/form/numberfield", [ "bui/form/basefield" ], function(e) {
	var t = e("bui/form/basefield"), n = t.extend({
		parseValue : function(e) {
			...
			e = e.replace(/\,/g, "");
			return n ? parseFloat(parseFloat(e).toFixed(
					t.get("decimalPrecision"))) : parseInt(e)
		},
...
define("bui/form/selectfield", [ "bui/common", "bui/form/basefield" ],
		function(e) {
			...
			var t = e("bui/common"), n = e("bui/form/basefield"), s = n.extend(
					{
						renderUI : function() {
							var e = this, t = e.getInnerControl(), n = e
									.get("select");
							if (e.get("srcNode") && t.is("select"))
								return;
						...
						setControlValue : function(e) {
							var t = this, n = t.get("select"), r = t
									.getInnerControl();
							r.val(e);
							n && n.set && n.getSelectedValue() !== e
									&& n.setSelectedValue(e)
						},
						getTipTigger : function() {
							var e = this, t = e.get("select");
							return t && t.rendered ? t.get("el").find("input")
									: e.get("el")
						},
						_uiSetItems : function(e) {
							e && this.setItems(e)
						...
						setInnerWidth : function(e) {
							var t = this, n = t.getInnerControl(), r = t
									.get("select"), i = n.outerWidth()
									- n.width();
							n.width(e - i);
...
define(
		"bui/form/datefield",
		[ "bui/common", "bui/form/basefield", "bui/calendar" ],
		function(e) {
			var t = e("bui/common"), n = e("bui/form/basefield"), r = t.Date, i = e("bui/calendar").DatePicker, s = n
					.extend({
						renderUI : function() {
							var e = this, t = e.get("datePicker");
							if ($.isPlainObject(t)) {
								t.trigger = e.getInnerControl();
								t.autoRender = !0;
								t = new i(t);
								e.set("datePicker", t);
								e.set("isCreatePicker", !0);
								e.get("children").push(t)
							}
							t.get("showTime")
									&& e.getInnerControl().addClass(
											"calendar-time")
						},
						bindUI : function() {
							var e = this, t = e.get("datePicker");
						...
						setControlValue : function(e) {
							...
							t.isDate(e)
									&& (e = r.format(e, n._getFormatMask()));
							i.val(e)
						},
						_getFormatMask : function() {
							var e = this, t = e.get("datePicker");
							return t.get("showTime") ? "yyyy-mm-dd HH:MM:ss"
									: "yyyy-mm-dd"
						},
						parseValue : function(e) {
...
define("bui/form/plainfield", [ "bui/form/basefield" ], function(e) {
	var t = e("bui/form/basefield"), n = t.View
			.extend(
					{
						_uiSetValue : function(e) {
							var t = this, n = t.get("textEl"), r = t
									.getControlContainer(), i = t
									.get("renderer"), s = i ? i(e) : e, o = t
									.get("width"), u = 0, a;
							n && n.remove();
							s = s || "&nbsp;";
...
define(
		"bui/form/listfield",
		[ "bui/common", "bui/form/basefield", "bui/list" ],
		function(e) {
			function i(e) {
				var n = e;
				if ($.isPlainObject(e)) {
			...
			var t = e("bui/common"), n = e("bui/list"), r = e("bui/form/basefield"), n = r
					.extend({
						initializer : function() {
							var e = this;
							e._initList()
						...
						_getListValue : function(e) {
							var t = this;
							e = e || t._getList();
							return e.getSelectionValues().join(",")
						},
						setControlValue : function(e) {
							var t = this, n = t.getInnerControl(), r = t
									._getList();
							n.val(e);
							if (t._getListValue(r) !== e && r.getCount()) {
								r.get("multipleSelect") && r.clearSelection();
								r.setSelectionByField(e.split(","))
							}
						},
						syncUI : function() {
						...
						_initList : function() {
							var e = this, n = e.get("defaultListCfg"), r = e
									.get("children"), i = e.get("list") || {};
							if (r[0])
								return;
							$.isPlainObject(i) && t.mix(i, n);
							r.push(i)
						},
						setItems : function(e) {
...
define(
		"bui/form/checklistfield",
		[ "bui/common", "bui/form/listfield" ],
		function(e) {
			"use strict";
			var t = e("bui/common"), n = e("bui/form/listfield"), r = n
					.extend(
							{},
							{
								ATTRS : {
...
(function() {
	var e = "bui/form/";
	define(e + "field", [ "bui/common", e + "textfield", e + "datefield",
			e + "selectfield", e + "hiddenfield", e + "numberfield",
			e + "checkfield", e + "radiofield", e + "checkboxfield",
			e + "plainfield", e + "listfield", e + "checklistfield",
			e + "radiolistfield" ], function(t) {
		...
		function(e) {
			...
			r.prototype = {
				getErrorsContainer : function() {
					...
					return n ? t.isString(n) ? e.get("el").find(n) : n : e
							.getContentElement()
				},
				showErrors : function(e) {
					var n = this, r = n.getErrorsContainer(), i = n
							.get("errorTpl");
					n.clearErrors();
					if (!n.get("showError"))
						return;
			...
			i.prototype = {
				...
				_getValidMessages : function() {
					var e = this, n = e.get("defaultMessages"), r = e
							.get("messages");
					return t.merge(n, r)
				},
				getValidError : function(e) {
					var t = this, n = t.get("validator"), r = null;
					r = t.validRules(t.get("defaultRules"), e)
							|| t.validRules(t.get("rules"), e);
					if (!r) {
						t.parseValue && (e = t.parseValue(e));
						r = n ? n.call(this, e) : ""
					}
					return r
				},
				...
				clearErrors : function(e) {
					e = e == null ? !0 : e;
					var n = this, r = n.get("children");
					e && t.each(r, function(e) {
						e.clearErrors && e.clearErrors()
					});
					n.set("error", null);
					n.get("view").clearErrors()
				},
	...
	BUI.augment(i, n,
			{
				...
				getErrors : function() {
					var e = this, t = e.get("children"), n = e
							.get("showChildError"), r = null, i = [];
					n && BUI.each(t, function(e) {
						e.getErrors && (i = i.concat(e.getErrors()))
					});
					if (e.isChildrenValid()) {
						r = e.get("error");
						r && i.push(r)
					}
					return i
...
define(
		"bui/form/fieldcontainer",
		[ "bui/common", "bui/form/field", "bui/form/groupvalid" ],
		function(e) {
			function f(e) {
				return e.is(a)
			}
			function l(e, n) {
				if (e != n) {
					if (f(e))
						return [ e ];
					var r = e.attr("class");
					if (r && (r.indexOf(u) !== -1 || r.indexOf(o) !== -1))
						return [ e ]
				}
				var i = [], s = e.children();
				t.each(s, function(e) {
			...
			var t = e("bui/common"), n = e("bui/form/field"), r = e("bui/form/groupvalid"), i = t.prefix, s = "form-field", o = i
					+ s, u = i + "form-group", a = "input,select,textarea", c = t.Component.View
					.extend([ r.View ]), h = t.Component.Controller
					.extend(
							[ r ],
							{
								syncUI : function() {
									var e = this, n = e.getFields(), r = e
											.get("validators");
									t.each(n, function(e) {
										var t = e.get("name");
								...
								findXClassByNode : function(e, n) {
									return e.attr("type") === "checkbox" ? s
											+ "-checkbox"
											: e.attr("type") === "radio" ? s
													+ "-radio"
													: e.attr("type") === "number" ? s
															+ "-number"
															: e
																	.hasClass("calendar") ? s
																	+ "-date"
																	: e[0].tagName == "SELECT" ? s
																			+ "-select"
																			: f(e) ? s
																					: t.Component.Controller.prototype.findXClassByNode
																							.call(
																									this,
																									e,
																									n)
								...
								getRecord : function() {
									...
									t.each(r, function(r) {
										var i = r.get("name"), s = e
												._getFieldValue(r);
										if (!n[i])
											n[i] = s;
										else if (t.isArray(n[i]) && s != null)
											n[i].push(s);
										else if (s != null) {
											var o = [ n[i] ];
											o.push(s);
								...
								_getFieldValue : function(e) {
									return e instanceof n.Check
											&& !e.get("checked") ? null : e
											.get("value")
								},
...
define("bui/form/group/base", [ "bui/common", "bui/form/fieldcontainer" ],
		function(e) {
			var t = e("bui/common"), n = e("bui/form/fieldcontainer"), r = n
					.extend({}, {
						ATTRS : {
							label : {
								view : !0
	...
	var t = e("bui/form/group/base"), r = t.extend({
		bindUI : function() {
			...
			e
					.on("change",
							function(t) {
								var r = n(e), i = e.get("range"), s = e
										.getRecord(), o = s[r], u = i[1];
								o && o.length >= u ? e._setFieldsEnable(r, !1)
										: e._setFieldsEnable(r, !0)
							})
		},
		...
		ATTRS : {
			range : {
				setter : function(e) {
					if (BUI.isString(e) || BUI.isNumber(e))
						e = [ parseInt(e) ];
					return e
				}
			}
...
define(
		"bui/form/group/select",
		[ "bui/form/group/base", "bui/data" ],
		function(e) {
			function i(e) {
				var t = [];
				BUI.each(e, function(e) {
			...
			var t = e("bui/form/group/base"), n = e("bui/data"), r = BUI.Component.UIBase.Bindable, s = t
					.extend([ r ], {
						initializer : function() {
							var e = this, t = e.get("url"), r = e.get("store")
									|| e._getStore();
							if (!r.isStore) {
								r.autoLoad = !0;
								t && (r.url = t);
						...
						onLoad : function(e) {
							var t = this, n = e ? e.node : t.get("store").get(
									"root");
						...
						_valueChange : function(e, t) {
							...
							if (e) {
								...
								if (!i)
									return;
								r.isLoaded(i) ? n._setFieldItems(t, i.children)
										: r.loadNode(i)
							} else
								n._setFieldItems(t, [])
						},
						_setFieldItems : function(e, t) {
							...
							if (r) {
								r.setItems(s);
								n._valueChange(r.get("value"), e + 1)
							}
						},
...
define("bui/form/fieldgroup",
		[ "bui/common", "bui/form/group/base", "bui/form/group/range",
				"bui/form/group/check", "bui/form/group/select" ], function(e) {
...
define("bui/form/form", [ "bui/common", "bui/toolbar",
		"bui/form/fieldcontainer" ], function(e) {
	var t = e("bui/common"), n = e("bui/toolbar").Bar, r = {
		NORMAL : "normal",
		AJAX : "ajax",
		IFRAME : "iframe"
	}, i = e("bui/form/fieldcontainer"), s = t.Component, o = i.View.extend({
		...
		renderUI : function() {
			...
			if ($.isPlainObject(r) && e.get("buttons")) {
				i = t.merge(e.getDefaultButtonBarCfg(), r);
				r = new n(i);
				e.set("buttonBar", r)
			}
			e._initSubmitMask()
		...
		bindUI : function() {
			...
			t.on("submit", function(t) {
				...
				if (e.isValid() && e.get("submitType") === r.AJAX) {
					t.preventDefault();
					e.ajaxSubmit()
				}
			})
		...
		submit : function(e) {
			var t = this, n = t.get("submitType");
			t.valid();
			if (t.isValid()) {
				if (t.onBeforeSubmit() == 0)
					return;
				n === r.NORMAL ? t.get("el")[0].submit() : n === r.AJAX
						&& t.ajaxSubmit(e)
			}
		},
		ajaxSubmit : function(e) {
			var n = this, r = n.get("method"), i = n.get("action"), s = n
					.get("callback"), o = n.get("submitMask"), u = n
					.serializeToObject(), a, f = t.merge(!0, {
				url : i,
				type : r,
				dataType : "json",
				data : u
			}, e);
			e && e.success && (a = e.success);
		...
		_initSubmitMask : function() {
			var e = this, n = e.get("submitType"), i = e.get("submitMask");
			n === r.AJAX && i && t.use("bui/mask", function(n) {
...
define(
		"bui/form/horizontal",
		[ "bui/common", "bui/form/form" ],
		function(e) {
			var t = e("bui/common"), n = e("bui/form/form"), r = n
					.extend(
							{
								getDefaultButtonBarCfg : function() {
									var e = this, t = e.get("buttons");
...
define(
		"bui/form/row",
		[ "bui/common", "bui/form/fieldcontainer" ],
		function(e) {
			var t = e("bui/common"), n = e("bui/form/fieldcontainer"), r = n
					.extend(
							{},
		...
		function(e) {
			...
			var t = e("bui/form/rule"), i = {}, s = {
				...
				validator : function(e, t, n) {
					...
					e = $.trim(e);
					if (e)
						return BUI.Date.isDateString(e) ? undefined : n
				}
			}), m = s.add({
				name : "minDate",
				msg : "输入日期不能小于{0}！",
		...
		function(e) {
			...
			n.prototype = {
				...
				_setLoading : function() {
					var e = this, t = e.get("loadingEl"), n = e
							.get("loadingTpl");
					if (!t) {
						t = $(n).appendTo(e.getLoadingContainer());
						e.setInternal("loadingEl", t)
					}
				},
			...
			r.prototype = {
				...
				_startRemote : function(e, t) {
					function o() {
						n._remoteValid(e, r, t);
						n.set("isLoading", !0)
					}
					var n = this, r = n.get("remoteHandler"), i = n
							.get("cacheMap"), s = n.get("remoteDaly");
					r && n._cancelRemote(r);
					if (i[t] != null) {
				...
				onRemoteComplete : function(e, t, n) {
					var r = this;
					if (n == r.get("remoteHandler")) {
						r.fire("remotecomplete", {
							error : e,
							data : t
						});
						r.set("isLoading", !1);
						r.setInternal("remoteHandler", null)
					}
				},
				_getOptions : function(e) {
					var n = this, r = n.get("remote"), i = n
							.get("defaultRemote"), s = t.merge(i, r, {
						data : e
					});
					return s
				},
				...
				_cancelRemote : function(e) {
					...
					if (e) {
						clearTimeout(e);
						t.setInternal("remoteHandler", null)
					}
					t.set("isLoading", !1)
				}
			};
...
define("bui/select", [ "bui/common", "bui/select/select", "bui/select/combox",
		"bui/select/suggest" ], function(e) {
...
define(
		...
		function(e) {
			...
			var t = e("bui/common"), n = e("bui/picker").ListPicker, r = t.prefix, s = t.Component, o = n, u = r
					+ "select-input", a = s.Controller
					.extend(
							{
								initializer : function() {
									var e = this, t = e.get("multipleSelect"), n, s = e
											.get("picker");
									if (!s) {
										n = t ? "listbox" : "simple-list";
										s = new o({
											children : [ {
												xclass : n,
												elCls : r + "select-list",
								...
								renderUI : function() {
									...
									t.set("textField", r);
									e.get("forceFit")
											&& t.set("width", n.outerWidth());
									t.render()
								},
								bindUI : function() {
									var e = this, t = e.get("picker"), n = t
											.get("list"), r = n.get("store");
									t.on("selectedchange", function(t) {
										e.fire("change", {
											text : t.text,
											value : t.value,
								...
								containsElement : function(e) {
									...
									return s.Controller.prototype.containsElement
											.call(this, e)
											|| n.containsElement(e)
								},
								_uiSetItems : function(e) {
							...
							},
							{
								ATTRS : {
									...
									tpl : {
										view : !0,
										value : '<input type="text" readonly="readonly" class="'
												+ u
												+ '"/><span class="x-icon x-icon-normal"><span class="x-caret x-caret-down"></span></span>'
									},
									triggerEvent : {
										value : "click"
									}
...
define("bui/select/combox", [ "bui/common", "bui/select/select" ], function(e) {
	...
	var t = e("bui/common"), n = e("bui/select/select"), r = t.prefix
			+ "combox-input", s = n.extend({
		renderUI : function() {
			var e = this, t = e.get("picker");
			t.set("autoFocused", !1);
			t.set("getFunction", i)
...
define(
		"bui/select/suggest",
		[ "bui/common", "bui/select/combox" ],
		function(e) {
			"use strict";
			var t = e("bui/common"), n = e("bui/select/combox"), r = 200, i = "", s = n
					.extend(
							{
								bindUI : function() {
									var e = this, t = e.get("el").find("input"), n = e
											.get("triggerEvent") === "keyup" ? "keyup"
											: "keyup click";
									t.on(n, function() {
										e._start()
									})
								...
								_updateContent : function() {
									var e = this, t = e.get("data"), n = e.get(
											"el").find("input"), r;
									if (!t && n.val() === e.get("query"))
										return;
									e.set("query", n.val());
									r = n.val();
									if (!t && !r)
										return;
									var i = e.get("cacheable"), s = e
											.get("url"), o = e.get("data");
									if (i && s) {
										var u = e.get("dataCache");
										u[r] !== undefined ? e
												._handleResponse(u[r]) : e
												._requestData()
									} else
										s ? e._requestData() : o
								...
								_handleResponse : function(e, t) {
									var n = this, r = t ? n._getFilterItems(e)
											: e;
									n.set("items", r);
									n.get("cacheable")
											&& (n.get("dataCache")[n
								...
								_getFilterItems : function(e) {
									...
									var n = this, r = [], i = n.get("el").find(
											"input"), s = i.val(), o = n
											.get("data");
									e = e || [];
									t.each(e, function(e) {
										var r = t.isString(e) ? e : n
												._getItemText(e);
										o ? r.indexOf($.trim(s)) !== -1
												&& u(r, e) : u(r, e)
									});
									return r
								},
								later : function(e, t, n) {
									t = t || 0;
									var r = n ? setInterval(e, t) : setTimeout(
											e, t);
									return {
										id : r,
										interval : n,
										cancel : function() {
											this.interval ? clearInterval(r)
													: clearTimeout(r)
										}
									}
								}
...
define("bui/mask", [ "bui/common", "bui/mask/mask", "bui/mask/loadmask" ],
		function(e) {
			...
			n.LoadMask = e("bui/mask/loadmask");
			return n
		});
define(
		"bui/mask/mask",
		[ "bui/common" ],
		function(e) {
			var t = e("bui/common"), n = t.namespace("Mask"), r = t.UA, i = t.prefix
					+ "ext-mask", s = i + "-msg";
			t
					.mix(
							n,
								...
								maskElement : function(e, n, o) {
									...
									if (!a.length) {
										a = $('<div class="' + i + '"></div>')
												.appendTo(u);
										u
												.addClass("x-masked-relative x-masked");
...
define("bui/mask/loadmask", [ "bui/mask/mask" ], function(e) {
	...
	BUI.augment(n, {
		...
		onBeforeLoad : function() {
			var e = this;
			e.get("disabled")
					|| t.maskElement(e.get("el"), e.get("msg"), this
							.get("msgCls"))
		},
		show : function() {
			this.onBeforeLoad()
...
define("bui/menu", [ "bui/common", "bui/menu/menu", "bui/menu/menuitem",
		"bui/memu/contextmenu", "bui/menu/popmenu", "bui/menu/sidemenu" ],
		function(e) {
...
define(
		...
		[ "bui/common" ],
		function(e) {
			var t = e("bui/common"), n = t.Component, r = n.UIBase, i = t.prefix, s = i
					+ "menu-item-open", o = "x-caret", u = i
					+ "menu-item-collapsed", a = "data-id", f = n.View.extend([
					r.ListItemView, r.CollapseableView ], {
				...
				handleMouseLeave : function(e) {
					...
					r && n && n.containsElement(r) ? t.set("open", !0) : t.set(
							"open", !1);
					l.superclass.handleMouseLeave.call(this, e)
				},
				containsElement : function(e) {
					var t = this, n, r = l.superclass.containsElement
							.call(t, e);
					if (!r) {
						n = t.get("subMenu");
						r = n && n.containsElement(e)
					}
					return r
				},
				_uiSetOpen : function(e) {
					var t = this, n = t.get("subMenu"), r = t
							.get("subMenuAlign");
					if (n)
						if (e) {
							r.node = t.get("el");
				...
				_uiSetSubMenu : function(e) {
					if (e) {
						...
						if (!e.get("parentMenu")) {
							e.set("parentMenu", r);
							r.get("autoHide") && e.set("autoHide", !1)
						}
...
define("bui/menu/menu", [ "bui/common" ], function(e) {
	var t = e("bui/common"), n = t.Component, r = n.UIBase, i = n.Controller
			.extend([ r.ChildList ], {
				bindUI : function() {
					var e = this;
					e.on("click", function(t) {
						var n = t.target, r = e.get("multipleSelect");
						e != n && !r && e.get("clickHide") && !n.get("subMenu")
								&& e.getTopAutoHideMenu().hide()
					});
				...
				getTopAutoHideMenu : function() {
					...
					return t && t.get("autoHide") ? t.getTopAutoHideMenu() : e
							.get("autoHide") ? e : null
				},
				_clearOpen : function() {
...
define(
		"bui/menu/popmenu",
		[ "bui/common", "bui/menu/menu" ],
		function(e) {
			var t = e("bui/common"), n = t.Component.UIBase, r = e("bui/menu/menu"), i = t.Component.View
					.extend([ n.PositionView ], {}), s = r.extend([ n.Position,
					n.Align, n.AutoShow, , n.AutoHide ], {}, {
				ATTRS : {
					clickHide : {
						value : !0
					},
...
define(
		"bui/memu/contextmenu",
		[ "bui/common", "bui/menu/menuitem", "bui/menu/popmenu" ],
		function(e) {
			var t = e("bui/common"), n = e("bui/menu/menuitem"), r = e("bui/menu/popmenu"), i = t.prefix, s = i
					+ "menu-item-link", o = i + "menu-item-icon", u = t.Component, a = u.UIBase, f = n
					.extend({
						bindUI : function() {
							var e = this;
						...
						_uiSetIconCls : function(e, t) {
							var n = this, r = t.prevVal, i = n.get("el").find(
									"." + o);
							i.removeClass(r);
							i.addClass(e)
						}
						...
						ATTRS : {
							...
							tpl : {
								value : '<a class="' + s
										+ '" href="#">        <span class="'
										+ o
										+ ' {iconCls}"></span><span class="'
										+ i
										+ 'menu-item-text">{text}</span></a>'
							}
						}
					}, {
...
define(
		...
		[ "bui/common", "bui/menu/menu" ],
		function(e) {
			var t = e("bui/common"), n = e("bui/menu/menu"), r = t.Component, i = t.prefix
					+ "menu-title", s = "menu-leaf", o = n.extend({
				initializer : function() {
				...
				_initMenuCfg : function(e) {
					var n = this, r = e.items, s = [], o = {
						...
						content : '<div class="' + i + '"><s></s><span class="'
								+ i + '-text">' + e.text + "</span></div>"
					};
					t.each(r, function(e) {
				...
				_initSubMenuCfg : function(e) {
					var n = this, r = {
						xclass : "menu-item",
						elCls : "menu-leaf" + (e.class ? " " + e.class : ""),
...
define("bui/tab", [ "bui/common", "bui/tab/tab", "bui/tab/tabitem",
		"bui/tab/navtabitem", "bui/tab/navtab", "bui/tab/tabpanel",
		"bui/tab/tabpanelitem" ], function(e) {
...
define(
		...
		[ "bui/common" ],
		function(e) {
			var t = e("bui/common"), n = t.Component, r = "tab-item-title", i = "tab-item-close", s = "tab-item-inner", o = "tab-nav-actived", u = "tab-content", a = n.View
					.extend(
							{
								renderUI : function() {
									var e = this, t = e
											.get("tabContentContainer"), n = e
											.get("tabContentTpl");
									if (t) {
										var r = $(n).appendTo(t);
								...
								_uiSetActived : function(e) {
									...
									e ? n.addClass(o) : n.removeClass(o)
								},
								destructor : function() {
							...
							},
							{
								ATTRS : {
									...
									tabContentTpl : {
										...
										value : '<div class="'
												+ u
												+ '" style="display:none;"><iframe src="" width="100%" height="100%" frameborder="0"></iframe></div>'
									},
									href : {
										view : !0,
										value : ""
...
define(
		...
		[ "bui/common", "bui/menu" ],
		function(e) {
			var t = e("bui/common"), n = e("bui/menu"), r = t.Component, i = "tab-nav-list", s = "arrow-left", o = "arrow-right", u = t.prefix
					+ "tab-force", a = "m_close", f = 140, l = r.View.extend(
					{
						renderUI : function() {
					...
					.extend(
							{
								...
								_bindScrollEvent : function() {
									var e = this, t = e.get("el");
									t.find(".arrow-left").on(
											"click",
											function() {
												t.hasClass(s + "-active")
														&& e._scrollLeft()
											});
									t.find(".arrow-right").on(
											"click",
											function() {
												t.hasClass(o + "-active")
														&& e._scrllRight()
								...
								_closeItem : function(e) {
									var t = this, n = t._getIndex(e), r = t
											.getActivedItem(), i = t
											.get("preItem")
											|| t._getItemByIndex(n - 1), s = t
											._getItemByIndex(n + 1);
									e.hide(function() {
										t.removeChild(e, !0);
										t._resetItemList();
										r === e ? i ? t._setItemActived(i) : t
												._setItemActived(s) : t
												._scrollToItem(r);
										t.forceFit()
									})
								...
								_getForceItemWidth : function() {
									var e = this, t = e.getContentElement()
											.width(), n = e.get("children"), r = e
											._getTotalWidth(), i = e.get(i);
									r > t && (i = t / n.length);
									return i
								},
								forceFit : function() {
								...
								_scrollToItem : function(e) {
									if (this.get("forceFit"))
										return;
									var t = this, n = t.getContentElement(), r = n
											.position(), i = t
											._getDistanceToEnd(e, n, r), s = t
											._getDistanceToBegin(e, r);
									if (n.width() < n.parent().width())
										t._scrollTo(n, 0);
									else if (s < 0)
										t._scrollTo(n, r.left - s);
									else if (i > 0)
										t._scrollTo(n, r.left + i * -1);
									else if (r.left < 0) {
								...
								_getDistanceToEnd : function(e, t, n) {
									var r = this, t = t
											|| r.getContentElement(), i = t
											.parent().width(), n = n
											|| t.position(), s = r
											._getDistanceToBegin(e, n), o = s
											+ r.get("itemWidth") - i;
									return o
								},
								...
								_scrollLeft : function() {
									var e = this, t = e.getContentElement(), n = t
											.position(), r = e
											._getLastDistance(t, n), i;
									if (r > 0) {
										i = r > e.get("itemWidth") ? e
												.get("itemWidth") : r;
										e._scrollTo(t, n.left - i)
									}
								},
								...
								_setArrowStatus : function(e, t) {
									...
									var n = this, r = n.get("el"), i = t
											|| e.position(), u = n
											._getLastDistance(e, t);
									i.left < 0 ? r.addClass(o + "-active") : r
											.removeClass(o + "-active");
									u > 0 ? r.addClass(s + "-active") : r
								...
								_setItemActived : function(e) {
									...
									if (e) {
										e.get("actived")
												|| e.set("actived", !0);
										e.get("visible") && t._scrollToItem(e);
										t.fire("activeChange", {
											item : e
										})
									}
							...
							},
							{
								ATTRS : {
									...
									tpl : {
										view : !0,
										value : '<div class="tab-nav-bar"><s class="tab-nav-arrow arrow-left"></s><div class="tab-nav-wrapper"><div class="tab-nav-inner"><ul class="'
												+ i
												+ '"></ul></div></div><s class="tab-nav-arrow arrow-right"></s>'
												+ "</div>"
...
define("bui/tab/tabitem", [ "bui/common" ], function(e) {
	var t = e("bui/common"), n = t.Component, r = n.UIBase, i = n.View.extend(
			[ r.ListItemView ], {}, {
...
define(
		...
		[ "bui/common", "bui/tab/tabitem" ],
		function(e) {
			var t = e("bui/common"), n = e("bui/tab/tabitem"), r = t.Component, i = n.View
					.extend({}, {
...
define("bui/tab/tabpanel", [ "bui/common", "bui/tab/tab" ], function(e) {
	var t = e("bui/common"), n = e("bui/tab/tab"), r = n
			.extend(
					{
						initializer : function() {
							var e = this, n = e.get("children"), r = $(e
									.get("panelContainer")), i = e
									.get("panelCls"), s = i ? r.find("." + s)
									: r.children();
...
define("bui/toolbar", [ "bui/common", "bui/toolbar/baritem", "bui/toolbar/bar",
		"bui/toolbar/pagingbar", "bui/toolbar/numberpagingbar" ], function(e) {
...
define(
		"bui/toolbar/baritem",
		function() {
			var e = BUI.prefix, t = BUI.Component, n = t.UIBase, r = t.View
					.extend([ n.ListItemView ]), i = t.Controller.extend(
					[ n.ListItem ], {
						renderUI : function() {
							var t = this.get("el");
					...
					.extend(
							{
								_uiSetDisabled : function(t) {
									var n = this, r = n.get("el"), i = t ? "addClass"
											: "removeClass";
									r.find("button").attr("disabled", t)[i](e
											+ "button-disabled")
								},
...
define(
		...
		[ "bui/toolbar/bar" ],
		function(e) {
			var t = e("bui/toolbar/bar"), n = BUI.Component, r = n.UIBase.Bindable, i = BUI.prefix, s = "first", o = "prev", u = "next", a = "last", f = "skip", l = "totalPage", c = "curPage", h = "totalCount", p = t
					.extend(
							[ r ],
							{
								initializer : function() {
									var e = this, t = e.get("children"), n = e
											.get("items"), r = e.get("store");
									if (!n || n.length) {
										n = e._getItems();
										BUI.each(n, function(e) {
											t.push(e)
								...
								jumpToPage : function(e) {
									if (e <= 0 || e > this.get("totalPage"))
										return;
									var t = this, n = t.get("store"), r = t
											.get("pageSize"), i = e - 1, s = i
											* r, o = t.fire("beforepagechange",
											{
												from : t.get("curPage"),
												to : e
											});
								...
								_bindButtonEvent : function() {
									function n() {
										var t = parseInt(e
												._getCurrentPageValue(), 10);
										e._isPageAllowRedirect(t) ? e
												.jumpToPage(t) : e
												._setCurrentPageValue(e
														.get("curPage"))
									}
									var e = this;
								...
								_getItems : function() {
									...
									if (t && t.length)
										return t;
									t = [];
									t.push(e._getButtonItem(s));
									t.push(e._getButtonItem(o));
									t.push(e._getSeparator());
									t.push(e._getTextItem(l));
									t.push(e._getTextItem(c));
									t.push(e._getButtonItem(f));
									t.push(e._getSeparator());
									t.push(e._getButtonItem(u));
									t.push(e._getButtonItem(a));
									t.push(e._getSeparator());
									t.push(e._getTextItem(h));
									return t
								},
								...
								_getTextItemTpl : function(e) {
									var t = this, n = {};
									n[e] = t.get(e);
									return BUI.substitute(this.get(e + "Tpl"),
											n)
								},
								...
								_setAllButtonsState : function() {
									var e = this, t = e.get("store");
									t
											&& e._setButtonsState([ o, u, s, a,
													f ], !0);
									e.get("curPage") === 1
											&& e._setButtonsState([ o, s ], !1);
									e.get("curPage") === e.get("totalPage")
											&& e._setButtonsState([ u, a ], !1)
								},
							...
							},
							{
								ATTRS : {
									...
									curPageTpl : {
										value : '第 <input type="text" autocomplete="off" class="'
												+ i
												+ 'pb-page" size="20" name="inputItem"> 页'
									},
									totalCountTpl : {
...
define(
		...
		[ "bui/toolbar/pagingbar" ],
		function(e) {
			var t = BUI.Component, n = e("bui/toolbar/pagingbar"), r = BUI.prefix, i = "numberContainer", s = r
					+ "button-number", o = n
					.extend(
							{
								_getItems : function() {
									...
									if (t)
										return t;
									t = [];
									t.push(e._getButtonItem(n.ID_PREV));
									t.push(e._getButtonItem(n.ID_NEXT));
									return t
								},
								_getButtonItem : function(e) {
									var t = this;
								...
								_bindButtonEvent : function() {
									...
									e.constructor.superclass._bindButtonEvent
											.call(this);
								...
								_setNumberButtons : function() {
									var e = this, t = e.get("curPage"), n = e
											.get("totalPage"), r = e
											._getNumberItems(t, n), i;
								...
								_appendNumberButton : function(e) {
									var t = this, n = t.getItemCount(), r = t
											.addItemAt(e, n - 1)
								},
								_clearNumberButtons : function() {
									var e = this, t = e.getItems(), n = e
											.getItemCount();
									while (n > 2) {
										e.removeItemAt(n - 2);
										n = e.getItemCount()
								...
								_getNumberItems : function(e, t) {
									function u(e, t) {
										for (var i = e; i <= t; i++)
											r.push(n._getNumberItem(i))
									}
									function a() {
										r.push(n._getEllipsisItem())
									}
									var n = this, r = [], i = n
											.get("maxLimitCount"), s = n
											.get("showRangeCount"), o;
									if (t < i) {
										o = t;
										u(1, t)
									} else {
										var f = e <= i ? 1 : e - s, l = e + s, c = l < t ? l > i ? l
												: i
												: t;
										if (f > 1) {
											u(1, 1);
...
define("bui/progressbar", [ "bui/common", "bui/progressbar/base",
		"bui/progressbar/load" ], function(e) {
...
define("bui/calendar", [ "bui/common", "bui/calendar/calendar",
		"bui/calendar/monthpicker", "bui/calendar/datepicker" ], function(e) {
...
define(
		...
		[ "bui/common", "bui/overlay", "bui/list", "bui/toolbar" ],
		function(e) {
			function v() {
			...
			var t = e("bui/common"), n = t.Component, r = e("bui/overlay").Overlay, i = e("bui/list").SimpleList, s = e("bui/toolbar"), o = t.prefix, u = "x-monthpicker-month", a = "data-month", f = "data-year", l = "x-monthpicker-year", c = "x-monthpicker-yearnav", h = "x-monthpicker-selected", p = "x-monthpicker-item", d = [
							...
							},
							{
								ATTRS : {
									itemTpl : {
										...
										value : '<li class="'
												+ p
												+ ' x-monthpicker-month"><a href="#" hidefocus="on">{text}</a></li>'
									},
									itemCls : {
										value : p
									},
					...
					.extend(
							{
								...
								_uiSetYear : function(e) {
									var t = this, n = t.findItemByField(
											"value", e);
									n ? t.setSelectedByField(e) : t.set(
											"start", e)
								},
								_setYearsContent : function() {
									var e = this, t = e.get("year"), n = e
											.get("start"), r = e
											.get("yearCount"), i = [];
									for (var s = n; s < n + r; s++) {
										var o = s.toString();
								...
								ATTRS : {
									...
									tpl : {
										...
										value : '<div class="'
												...
												+ '<span class="'
												+ c
												+ '-prev x-icon x-icon-normal x-icon-small"><span class="icon icon-caret icon-caret-left"></span></span>'
												+ '<span class="'
												+ c
												+ '-next x-icon x-icon-normal x-icon-small"><span class="icon icon-caret icon-caret-right"></span></span>'
												+ "</div>" + "<ul></ul>"
									}
								}
							}, {
					...
					.extend(
							{
								initializer : function() {
									var e = this, t = e.get("children"), n = new m, r = new g, i = e
											._createFooter();
									t.push(n);
									t.push(r);
									t.push(i);
...
define(
		...
		[ "bui/common" ],
		function(e) {
			var t = e("bui/common"), n = t.prefix, r = t.Component, i = "year-text", s = "month-text", o = "x-datepicker-arrow", u = "x-datepicker-prev", a = "x-datepicker-next", f = r.Controller
					.extend(
							{
								bindUI : function() {
									var e = this, t = e.get("el");
								...
								nextMonth : function() {
									var e = this, t = new Date(e.get("year"), e
											.get("month") + 1);
								...
								ATTRS : {
									...
									tpl : {
										...
										value : '<div class="'
												...
												+ " "
												+ u
												+ '"><span class="icon icon-white icon-caret  icon-caret-left"></span></div>'
												...
												+ " "
												+ a
												+ '"><span class="icon icon-white icon-caret  icon-caret-right"></span></div>'
									},
									elCls : {
										view : !0,
...
define(
		...
		function(e) {
			var t = e("bui/common"), n = t.Component, r = t.Date, i = "x-datepicker-date", s = "x-datepicker-today", o = "x-datepicker-disabled", u = "x-datepicker-active", a = "data-date", f = "isoDate", l = "x-datepicker-selected", c = 6, h = {
				...
				active : "active",
				disabled : "disabled"
			}, p = [ "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday",
					"Friday", "Saturday" ], d = n.View
					.extend(
							{
								renderUI : function() {
									this.updatePanel()
								...
								_getDayTpl : function(e) {
									var n = this, i = n.get("dayTpl"), o = e
											.getDay(), u = n._isToday(e) ? s
											: "", a = p[o], l = e.getDate(), c = n
											._isInRange(e) ? n
											._isCurrentMonth(e) ? h.active
											: h.deactive : h.disabled;
									return t.substitute(i, {
										dayOfWeek : a,
										dateType : c,
										dateNumber : l,
								...
								_getFirstDate : function(e, t) {
									var n = this, i = n
											._getMonthFirstDate(e, t), s = i
											.getDay();
									return r.addDay(s * -1, i)
								},
								_getMonthFirstDate : function(e, t) {
									var n = this, e = e || n.get("year"), t = t
											|| n.get("month");
									return new Date(e, t)
								},
								...
								_isInRange : function(e) {
									var t = this, n = t.get("maxDate"), r = t
											.get("minDate");
									return r && e < r ? !1 : n && e > n ? !1
											: !0
								},
								...
								_findDateElement : function(e) {
									var t = this, n = r.format(e, f), s = t
											.get("el").find("." + i), o = null;
					...
					.extend(
							{
								initializer : function() {
									...
									e.get("year")
											|| e.set("year", t.getFullYear());
									e.get("month")
											|| e.set("month", t.getMonth())
								},
								bindUI : function() {
									var e = this, t = e.get("el");
								...
								performActionInternal : function(e) {
									var t = this, n = $(e.target).closest(
											"." + i);
									if (n) {
										var s = n.attr("title");
										if (s) {
											s = r.parse(s);
											t.get("view")._isInRange(s)
													&& t.set("selected", s)
										}
									}
								},
								...
								_uiSetSelected : function(e, t) {
									var n = this;
									if (!(t && t.prevVal && r.isDateEquals(e,
											t.prevVal))) {
										n.setMonth(e.getFullYear(), e
												.getMonth());
										n.get("view")._setSelectedDate(e);
										n.fire("selectedchange", {
											date : e
										})
									}
								},
...
define(
		...
		[ "bui/picker", "bui/calendar/monthpicker", "bui/calendar/header",
				"bui/calendar/panel", "bui/toolbar" ],
		function(e) {
			function v() {
				var e = new Date;
				return new Date(e.getFullYear(), e.getMonth(), e.getDate())
			...
			var t = e("bui/common"), n = t.prefix, r = "x-datepicker-time", i = "x-datepicker-hour", s = "x-datepicker-minute", o = "x-datepicker-second", u = "x-timepicker", a = e("bui/picker").ListPicker, f = e("bui/calendar/monthpicker"), l = e("bui/calendar/header"), c = e("bui/calendar/panel"), h = e("bui/toolbar"), p = t.Component, d = t.Date, w = p.Controller
					.extend(
							{
								initializer : function() {
									var e = this, t = e.get("children"), n = new l, r = new c, i = e
											.get("footer")
											|| e._createFooter(), s = e
											.get("monthPicker")
											|| e._createMonthPicker();
									t.push(n);
									t.push(r);
									t.push(i);
									t.push(s);
								...
								bindUI : function() {
									...
									n.on("selectedchange", function(t) {
										...
										d
												.isDateEquals(n, e
														.get("selectedDate"))
												|| e.set("selectedDate", n)
									});
									e.get("showTime") ? e
											._initTimePickerEvent() : n.on(
											"click", function() {
												e.fire("accept")
											});
									...
									var c = new a(
											{
												...
												trigger : e.get("el").find(
														"." + r)
											});
									c.render();
									e._initTimePickerEvent(c);
									return c
								},
								_initTimePickerEvent : function(e) {
									...
									e.on("triggerchange", function(t) {
										var n = t.curTrigger;
										n.hasClass(i) ? e.get("list").set(
												"items", g(24)) : e.get("list")
												.set("items", g(60))
									});
									e.on("selectedchange", function(e) {
										var n = e.curTrigger, r = e.value;
										n.hasClass(i) ? t
												.setInternal("hour", r) : n
												.hasClass(s) ? t.setInternal(
												"minute", r) : t.setInternal(
												"second", r)
									})
								},
								_setYearMonth : function(e, t) {
									var n = this, r = n.get("selectedDate"), i = r
											.getDate();
									(e !== r.getFullYear() || t !== r
											.getMonth())
											&& n.set("selectedDate", new Date(
													e, t, i))
								},
								...
								_uiSetSelectedDate : function(e) {
									var t = this, n = e.getFullYear(), r = e
											.getMonth();
							...
							},
							{
								ATTRS : {
									...
									lockTime : {},
									timeTpl : {
										value : '<input type="text" readonly class="'
												+ r
												+ " "
												+ i
...
define(
		...
		[ "bui/common", "bui/picker", "bui/calendar/calendar" ],
		function(e) {
			var t = e("bui/common"), n = e("bui/picker").Picker, r = e("bui/calendar/calendar"), i = t.Date, s = n
					.extend(
							{
								initializer : function() {
								...
								setSelectedValue : function(e) {
									var t = this, n = this.get("calendar"), r = i
											.parse(e, t.get("dateMask"));
									r = r || new Date((new Date).setSeconds(0));
									n.set("selectedDate", i.getDate(r));
									if (t.get("showTime")) {
										var s = this.get("lockTime"), o = s
												&& s.hour ? s.hour : r
												.getHours(), u = s && s.minute ? s.minute
												: r.getMinutes(), a = s
												&& s.second ? s.second : r
												.getSeconds();
										n.set("hour", o);
								...
								getSelectedValue : function() {
									var e = this, t = e.get("calendar"), n = i
											.getDate(t.get("selectedDate"));
									if (e.get("showTime")) {
										n = i.addHour(t.get("hour"), n);
										n = i.addMinute(t.get("minute"), n);
										n = i.addSecond(t.get("second"), n)
									}
									return n
								},
								getSelectedText : function() {
									return i.format(this.getSelectedValue(),
											this._getFormatType())
								},
...
define("bui/editor", [ "bui/common", "bui/form", "bui/editor/editor",
		"bui/editor/record", "bui/editor/dialog" ], function(e) {
...
define("bui/editor/mixin", function(e) {
	function t(e) {
		var t = e, n = t.get("controlCfgField"), r = t.get(n), i = t
				.addChild(r);
		t.setInternal(n, i)
	}
	var n = function() {
	...
	n.prototype = {
		__bindUI : function() {
			var e = this, t = e.get("acceptEvent"), n = e
					.get("changeSourceEvent");
			t && e.on(t, function() {
				if (e.accept())
					return;
				if (e.get("preventHide"))
					return !1;
				e.cancel()
			});
			n && e.on(n, function() {
...
define(
		"bui/editor/editor",
		[ "bui/common", "bui/overlay", "bui/editor/mixin" ],
		function(e) {
							...
							[ Mixin ],
							{
								bindUI : function() {
									...
									e.on("validchange", function(t) {
										!e.isValid() && e.get("visible") ? e
												._showError(e.getErrors()) : e
												._hideError()
									});
									e.on("hide", function() {
										e._hideError()
								...
								_showError : function(e) {
									var n = this, r = n.get("overlay")
											|| n._initOverlay(), i = n
											._getErrorList(), s = n
											.get("errorAlign"), o = t.Array
											.map(e, function(e) {
												return {
													error : e
												}
...
define("bui/editor/dialog", [ "bui/overlay", "bui/editor/mixin" ], function(e) {
	var t = e("bui/overlay").Dialog, n = e("bui/editor/mixin"), r = t.extend(
			[ n ], {
				getSourceValue : function() {
					return this.get("record")
				},
...
define("bui/grid", [ "bui/common", "bui/grid/simplegrid", "bui/grid/grid",
		"bui/grid/column", "bui/grid/header", "bui/grid/format",
		"bui/grid/plugins" ], function(e) {
...
define(
		...
		[ "bui/common", "bui/list" ],
		function(e) {
			var t = e("bui/common"), n = e("bui/list"), r = t.Component, i = r.UIBase, s = t.prefix, o = s
					+ "grid", u = o + "-row", a = s + "grid-row-odd", f = s
					+ "grid-row-even", l = s + "grid-border", c = s
					+ "grid-row-first", h = n.SimpleListView
					.extend(
							{
								...
								_createColumn : function(e, n) {
									var r = this, i = t.substitute(r
											.get("columnTpl"), e);
									$(i).appendTo(n)
								},
								getItemTpl : function(e, n) {
									var r = this, i = r.get("columns"), s = r
											.get("rowTpl"), o = n % 2 === 0 ? a
											: f, u = [], l;
									t.each(i, function(t) {
										var n = t.dataIndex;
					...
					.extend(
							{
								...
								bindUI : function() {
									var e = this, t = e.get("itemCls"), n = t
											+ "-hover", r = e.get("el");
							...
							},
							{
								ATTRS : {
									...
									cellTpl : {
										...
										value : '<td class="'
												+ o
												+ '-cell {elCls}"><div class="'
												+ o
												+ '-cell-inner"><span class="'
												+ o
												+ '-cell-text">{text}</span></div></td>'
									},
									columnTpl : {
										view : !0,
										value : '<th class="'
												+ o
												+ '-hd {elCls}" width="{width}"><div class="'
												+ o
												+ '-hd-inner"><span class="'
												+ o
												+ '-hd-title">{title}</span></div></th>'
									},
									events : {
										value : {}
									},
...
define(
		...
		[ "bui/common" ],
		function(e) {
			var t = e("bui/common"), n = t.prefix, r = n + "grid-hd-title", i = n
					+ "grid-hd-open", s = "sort-", o = "ASC", u = "DESC", a = n
					+ "grid-hd-menu-trigger", f = "grid-hd-menu-trigger", l = t.Component.View
					.extend({
						setTplContent : function(e) {
							var t = this, n = t.get("sortTpl"), i = t
									.get("triggerTpl"), s = t.get("el"), o;
						...
						_uiSetShowMenu : function(e) {
							var t = this, n = t.get("triggerTpl"), i = t
									.get("el"), s = i.find("." + r);
						...
						_uiSetSortState : function(e) {
							var t = this, n = t.get("el"), r = e ? "addClass"
									: "removeClass", i = s + "asc", o = s
									+ "desc";
							n.removeClass(i + " " + o);
							e === "ASC" ? n.addClass(i) : e === "DESC"
									&& n.addClass(o)
						},
						_uiSetOpen : function(e) {
							var t = this, n = t.get("el");
				...
				_toggleSortState : function() {
					var e = this, t = e.get("sortState"), n = t ? t === o ? u
							: o : o;
					e.set("sortState", n)
				},
				performActionInternal : function(e) {
					var t = this, n = $(e.target), r = t.get("prefixCls");
					n.hasClass(r + f) || t.get("sortable")
							&& t._toggleSortState()
				},
				_uiSetWidth : function(e) {
				...
				ATTRS : {
					...
					tpl : {
						sync : !1,
						view : !0,
						value : '<div class="' + n + 'grid-hd-inner">'
...
define(
		"bui/grid/header",
		[ "bui/common", "bui/grid/column" ],
		function(e) {
			var t = e("bui/common"), n = t.prefix, r = t.namespace("Grid"), i = e("bui/grid/column"), s = t.Component.View, o = t.Component.Controller, u = 17, a = t.UA, f = s
					.extend({
						getContentElement : function() {
					...
					.extend(
							{
								...
								forceFitColumns : function() {
									...
									var e = this, t = e.getColumns(), n = e
											.get("width"), r = n, i = e
											.getColumnOriginWidth(), s = 0, o = 0, a = null, f = e
											._isAllowScrollLeft();
									if (n) {
										if (f) {
											n -= u;
								...
								_getColumnBorderWith : function(e, t) {
									var n = e.get("el"), r = Math
											.round(parseFloat(n
													.css("border-left-width")) || 0)
											+ Math
													.round(parseFloat(n
															.css("border-right-width")) || 0);
									r = a.ie && a.ie < 8 ? t === 0 ? 1 : r : r;
									return r
								},
								setTableWidth : function() {
									...
									if (e.get("forceFit"))
										e.forceFitColumns();
									else if (e._isAllowScrollLeft()) {
										n = e.getColumnsWidth();
										r = e.get("emptyColumn");
										t < n ? r.get("el").width(u) : r.get(
												"el").width("auto")
									}
								},
							...
							},
							{
								ATTRS : {
									...
									tpl : {
										view : !0,
										value : '<table cellspacing="0" class="'
												+ n
...
define(
		"bui/grid/grid",
		[ "bui/common", "bui/mask", "bui/toolbar", "bui/list",
				"bui/grid/header", "bui/grid/column" ],
		function(e) {
			function f(e) {
			...
			var t = e("bui/common"), n = e("bui/mask"), r = t.UA, i = t.Component, s = e("bui/toolbar"), o = e("bui/list"), u = e("bui/grid/header"), a = e("bui/grid/column"), l = t.prefix, c = l
					+ "grid-header-container", h = l + "grid-body", p = l
					+ "grid-width", d = l + "grid-height", v = l
					+ "grid-border", m = l + "grid-tbar", g = l + "grid-bbar", y = l
					+ "grid-button-bar", b = l + "grid-strip", w = l
					+ "grid-row", E = l + "grid-row-odd", x = l
					+ "grid-row-even", T = l + "grid-row-first", N = l
					+ "grid-cell", C = l + "grid-cell-inner", k = "grid-td-", L = l
					+ "grid-cell-text", A = l + "grid-cell-empty", O = "17", M = l
					+ "hidden", _ = "data-column-field", D = 2, P = 1, B = o.SimpleListView
					.extend(
							{
								renderUI : function() {
									var e = this, t = e.get("el"), n = t
								...
								getItemTpl : function(e, n) {
									var r = this, i = r._getColumns(), s = r
											.get("tbodyEl"), o = r
											.get("rowTpl"), u = n % 2 === 0 ? E
											: x, a = [], f;
									$.each(i, function(t, n) {
										var i = n.get("dataIndex");
										a.push(r._getCellTpl(n, i, e, t))
									});
									r.get("useEmptyCell")
											&& a.push(r._getEmptyCellTpl());
									o = t.substitute(o, {
										cellsTpl : a.join(""),
										oddCls : u
									});
								...
								resetHeaderRow : function() {
									if (!this.get("useHeaderRow"))
										return;
									var e = this, t = e.get("headerRowEl"), n = e
											.get("tbodyEl");
									t && t.remove();
								...
								resetColumnsWidth : function(e, t) {
									var n = this, r = n.get("headerRowEl"), i = n
											.findCell(e.get("id"), r);
									t = t || e.get("width");
									i && i.width(t);
									n.setTableWidth()
								...
								setTableWidth : function(e) {
									...
									var t = this, n = t._getInnerWidth(), i = t
											.get("height"), s = t
											.get("tableEl"), o = t
											.get("forceFit"), u = t
											.get("headerRowEl");
								...
								setBodyHeight : function(e) {
									var n = this, r = n.get("bodyEl"), i = e, s = r
											.siblings();
									t.each(s, function(e) {
										$(e).css("display") !== "none"
												&& (i -= $(e).outerHeight())
								...
								setColumnVisible : function(e) {
									var t = this, n = !e.get("visible"), r = e
											.get("id"), i = t.get("tbodyEl"), s = $(
											"." + k + r, i);
									n ? s.hide() : s.show()
								},
								updateItem : function(e) {
									var n = this, r = n.getItems(), i = t.Array
											.indexOf(e, r), s = n._getColumns(), o = null, u;
									if (i >= 0) {
										o = n.findElement(e);
										t
												.each(
								...
								showEmptyText : function() {
									var e = this, t = e.get("bodyEl"), n = e
											.get("emptyDataTpl"), r = e
											.get("emptyEl");
									r && r.remove();
									var r = $(n).appendTo(t);
									e.set("emptyEl", r)
								...
								_createHeaderRow : function() {
									var e = this, n = e._getColumns(), r = e
											.get("tbodyEl"), i = e
											.get("headerRowTpl"), s, o = [];
									$.each(n, function(t, n) {
										o.push(e._getHeaderCellTpl(n))
									});
									e.get("useEmptyCell")
											&& o.push(e._getEmptyCellTpl());
									i = t.substitute(i, {
										cellsTpl : o.join("")
									});
									s = $(i).appendTo(r);
								...
								_getCellText : function(e, n, r) {
									var i = this, s = e.get("dataIndex"), o = e
											.get("cellTpl")
											|| i.get("cellTextTpl"), u = i
											._getCellInnerText(e, s, n, r);
								...
								_getCellInnerText : function(e, t, n, r) {
									try {
										var i = this, s = e.get("renderer"), o = s ? s(
												n[t], n, r)
												: n[t];
										return o == null ? "" : o
									} catch (u) {
										throw "column:" + e.get("title")
												+ " fomat error!"
									}
								},
								_getCellTpl : function(e, n, r, i) {
									var s = this, o = s._getCellText(e, r, i), u = s
											.get("cellTpl");
									return t.substitute(u, {
										elCls : e.get("elCls"),
										id : e.get("id"),
					...
					.extend(
							{
								...
								findCell : function(e, t) {
									var n = this, r = null;
									t instanceof $ ? r = t : r = n.findRow(t);
									return r ? n.get("view").findCell(e, r)
											: null
								},
								findRow : function(e) {
									var t = this;
								...
								_bindScrollEvent : function() {
									var e = this, t = e.get("el"), n = t
											.find("." + h), r = e.get("header");
									n.on("scroll", function() {
										var t = n.scrollLeft(), i = n
												.scrollTop();
										r.scrollTo({
											left : t,
											top : i
								...
								_bindHeaderEvent : function() {
									...
									t.on("afterSortStateChange", function(e) {
										...
										n
												&& r
												&& r.sort(t.get("dataIndex"), t
														.get("sortState"))
									});
									t.on("afterVisibleChange", function(r) {
										var i = r.target;
										if (i !== t) {
											n.setColumnVisible(i);
											e.fire("columnvisiblechange", {
												column : i
											})
										}
									});
								...
								_bindItemsEvent : function() {
									...
									e.on("itemclick", function(t) {
										var n = t.domTarget, r = t.item, i = $(
												n).closest("." + N), s = $(n)
												.closest("." + w), o;
										i.length && (o = e.fire("cellclick", {
											record : r,
											row : s[0],
											cell : i[0],
											field : i.attr(_),
								...
								_uiSetHeight : function(e, t) {
									...
									if (n.get("rendered")) {
										if (n.get("forceFit") && !t.prevVal) {
											r.forceFitColumns();
											n.get("view").setTableWidth()
										}
										r.setTableWidth()
									}
								}
							},
							{
								ATTRS : {
									...
									headerRowTpl : {
										...
										value : '<tr class="'
												+ l
												+ 'grid-header-row">{cellsTpl}</tr>'
									},
									headerCellTpl : {
										view : !0,
										value : '<td class="{hideCls} '
												+ k
												+ '{id}" width="{width}" style="height:0"></td>'
									},
									rowTpl : {
										view : !0,
										value : '<tr class="' + w
									...
									cellTpl : {
										view : !0,
										value : '<td  class="{elCls} {hideCls} '
												+ N
												+ " "
												+ k
												+ '{id}" data-column-id="{id}" data-column-field = "{dataIndex}" >'
												+ '<div class="'
												+ C
												+ '" >{cellText}</div>'
												+ "</td>"
...
define("bui/grid/format", function(e) {
	...
	var n = {
		dateRenderer : function(e) {
			...
			return !n || !n.getFullYear ? "" : n.getFullYear() + "-"
					+ t(n.getMonth() + 1) + "-" + t(n.getDate())
		},
		...
		cutTextRenderer : function(e) {
			return function(t) {
				t = t || "";
				return t.toString().length > e ? t.toString().substring(0, e)
						+ "..." : t
			}
		},
		...
		multipleItemsRenderer : function(e) {
			...
			return function(e) {
				...
				if (!e)
					return "";
				BUI.isArray(e) || (e = e.toString().split(","));
				$.each(e, function(e, r) {
					n.push(t(r))
				});
				return n.join(",")
		...
		moneyCentRenderer : function(e) {
			BUI.isString(e) && (e = parseFloat(e));
			return $.isNumberic(e) ? (e * .01).toFixed(2) : e
		}
	};
	return n
});
(function() {
	...
	define("bui/grid/plugins", [ "bui/common", e + "selection", e + "cascade",
			e + "cellediting", e + "rowediting", e + "autofit",
			e + "dialogediting", e + "menu", e + "summary" ], function(t) {
...
define(
		"bui/grid/plugins/menu",
		[ "bui/common", "bui/menu" ],
		function(e) {
			var t = e("bui/common"), n = e("bui/menu"), r = t.prefix, i = "sort-asc", s = "sort-desc", o = "column-setting", u = "icon-check", a = function(
					e) {
			...
			t.augment(a, {
				...
				bindUI : function(e) {
					...
					e.on("columnclick", function(e) {
						...
						if (n.hasClass(t.get("triggerCls"))) {
							i = t.get("menu") || t._initMenu();
							i.set("align", {
								node : n,
								points : [ "bl", "tl" ],
								offset : [ 0, 0 ]
				...
				_resetColumnsVisible : function(e) {
					var t = this, n = e.findItemById(o), r = n.get("subMenu")
							|| t._initColumnsMenu(n), i = t.get("grid").get(
							"columns");
					r.removeChildren(!0);
					$.each(i, function(e, t) {
						if (!t.get("fixed")) {
				...
				_initMenuEvent : function(e) {
					...
					e.on("itemclick", function(e) {
						var n = e.item, r = n.get("id"), o = t
								.get("activedColumn");
						r === i ? o.set("sortState", "ASC") : r === s
								&& o.set("sortState", "DESC")
					});
				...
				_initColumnsMenu : function(e) {
					...
					t.on("itemclick", function(e) {
						var t = e.item, n = t.get("column"), r = t
								.get("selected");
...
define(
		...
		[ "bui/common" ],
		function(e) {
			var t = e("bui/common"), n = t.prefix, r = "", i = "data-record", s = n
					+ "grid-cascade", o = s + "-expand", u = s + "-row", a = s
					+ "-cell", f = s + "-collapse", l = function(e) {
			...
			l.ATTRS = {
				...
				cellInner : {
					value : '<span class="' + s + '"><i class="' + s
							+ '-icon"></i></span>'
				},
				rowTpl : {
					value : '<tr class="' + u + '"><td class="' + a
							+ '"></td></tr>'
				},
				renderer : {},
							...
							l,
							{
								...
								bindUI : function(e) {
									...
									e.on("cellclick", function(e) {
										var n = $(e.domTarget), r = n
												.closest("." + s);
										r.length
												&& (r.hasClass(o) ? t
														._onCollapse(e.record,
																e.row, r) : t
														._onExpand(e.record,
																e.row, r))
									});
								...
								_createCascadeRow : function(e, t) {
									var n = this, r = n.get("rowTpl"), s = n
											._getRowContent(e), o = $(r)
											.insertAfter(t);
									o.find("." + a).append($(s));
									o.data(i, e);
									return o
								...
								_onExpand : function(e, t, n) {
									var r = this, i = r._getCascadeRow(t), u = r
											._getColumnCount(t);
									n = n || $(t).find("." + s);
									n.addClass(o);
									if (!i || !i.length)
										i = r._createCascadeRow(e, t);
									$(i).removeClass(f);
									r._setColSpan(i, t);
									r.fire("expand", {
										record : e,
...
define(
		...
		function(e) {
			...
			var t = e("bui/common"), n = t.prefix, r = n + "grid-checkBox", i = "x-grid-checkbox", s = n
					+ "grid-radio";
			t.extend(o, t.Base);
			o.ATTRS = {
				width : {
				...
				column : {},
				cellInner : {
					value : '<div class="' + r + '-container"><span class="'
							+ i + '"></span></div>'
				}
			};
			t.augment(o, {
				...
				bindUI : function(e) {
					var t = this, n = t.get("column"), r = n.get("el"), s = r
							.find("." + i);
					s.on("click", function() {
			...
			u.ATTRS = {
				...
				cellInner : {
					value : '<div class="' + n
							+ 'grid-radio-container"><input  class="' + s
							+ '" type="radio"></div>'
				}
			};
			t.augment(u, {
...
define(
		...
		function(e) {
			function l(e) {
				return e > 0 ? '<td class="' + f + '" colspan="' + e
						+ '">&nbsp;</td>' : ""
			}
			function c(e, t) {
			...
			function h(e) {
				return '<div class="' + o + '" >' + '<span class="' + a + ' ">'
						+ e + "</span>" + "</div>"
			}
			function p() {
				return '<td class="' + f + " " + f + '-empty">&nbsp;</td>'
			}
			var t = e("bui/common"), n = t.prefix, r = n + "grid-row", i = n
					+ "grid-body", s = n + "grid-summary-row", o = n
					+ "grid-cell-inner", u = "grid-td-", a = n
					+ "grid-cell-text", f = n + "grid-cell", d = function(e) {
			...
			t
					.augment(
							d,
							{
								...
								renderUI : function(e) {
									var t = this, n = e.get("el").find("." + i), r = n
											.find("table"), s = $(
											t.get("footerTpl")).appendTo(r);
									t.set("footerEl", s)
								},
								bindUI : function(e) {
									var t = this, n = e.get("store");
									if (n) {
										n.on("beforeprocessload", function(e) {
								...
								_processSummary : function(e) {
									...
									if (!e)
										return;
									var r = e[t.get("pageSummaryField")], i = e[t
											.get("summaryField")];
									t.set("pageSummary", r);
									t.set("summary", i)
								},
								resetPageSummary : function() {
									var e = this, n = e.get("grid"), r = n
											.get("columns"), i = e
											._calculatePageSummary(), s = e
											.get("pageEl");
									e.set("pageSummary", i);
									if (s) {
										t
										...
										e._updateFirstRow(s, e
												.get("pageSummaryTitle"))
									}
								},
								resetSummary : function(e, t) {
									...
									if (!e) {
										e = n._calculatePageSummary();
										n.set("pageSummary", e)
									}
									t = t || n.get("summary");
									i = n._creatSummaryRow(e, n
											.get("pageSummaryTitle"));
									n.set("pageEl", i);
									n
											._creatSummaryRow(t, n
													.get("summaryTitle"))
								},
								_creatSummaryRow : function(e, t) {
									if (!e)
										return null;
									var n = this, r = n.get("footerEl"), i = n
											._getSummaryTpl(e), s = $(i)
											.appendTo(r);
									n._updateFirstRow(s, t);
									return s
								},
								_updateFirstRow : function(e, t) {
									var n = e.find("td").first(), r = n
											.find("." + o);
									if (r.length) {
										var i = t + ": ";
										text = r.text();
								...
								_getSummaryTpl : function(e) {
									var t = this, n = t.get("grid"), i = n
											.get("columns"), o = [], u = -1, a = -1, f = null;
									$.each(i, function(n, r) {
										if (r.get("visible")) {
											a += 1;
											if (r.get("summary")) {
												o.push(l(a - u - 1));
												var i = t._getSummaryCellText(
														r, e), s = c(i, r
														.get("id"));
												o.push(s);
												u = a
								...
								_getSummaryCellText : function(e, t) {
									var n = this, r = t[e.get("dataIndex")], i = r == null ? ""
											: r, s = e.get("renderer"), o = s ? s(
											i, t)
											: i;
									return o
								},
...
define("bui/grid/plugins/editing", function(e) {
	...
	r.ATTRS = {
		...
		errorTpl : {
			value : '<span class="x-icon ' + n
					+ ' x-icon-mini x-icon-error" title="{error}">!</span>'
		},
		isInitEditors : {
			value : !1
		},
	...
	BUI.augment(r, {
		...
		_initGridEvent : function(e) {
			...
			e.on("cellclick", function(e) {
				var n = null, r = e.domTarget, i = t.get("triggerCls"), s = t
						._getCurEditor();
				if (s && s.get("acceptEvent")) {
					s.accept();
					s.hide()
				} else
					s && s.cancel();
		...
		initEditors : function(e) {
			...
			BUI.each(i,
					function(e) {
						...
						if (n) {
							n.name = e.get("dataIndex");
							n.id = e.get("id");
							n.validator
									&& (n.validator = t
											.wrapValidator(n.validator));
							r.push(n)
						}
					});
		...
		_createEditOptions : function(e, t) {
			var n = this, r = n.get("grid"), i = r.findRow(e), s = r
					.findColumnByField(t), o = r.findCell(s.get("id"), i);
			return {
				record : e,
				field : t,
				cell : o[0],
		...
		isValid : function() {
			var e = this, t = e.get("grid");
			e.get("hasValid") || e.valid();
			return !t.get("el").find("." + n).length
		},
		clearErrors : function() {
			var e = this, t = e.get("grid");
		...
		_showCellError : function(e, n) {
			var r = this, i = BUI.substitute(r.get("errorTpl"), {
				error : n
			}), s = e.find("." + t);
			$(i).appendTo(s)
		},
...
define(
		...
		function(e) {
			var t = e("bui/grid/plugins/editing"), n = BUI.prefix + "grid-body", r = BUI.prefix
					+ "grid-cell", i = function(e) {
				i.superclass.constructor.call(this, e)
			};
			i.ATTRS = {
				triggerCls : {
			...
			BUI.augment(i, {
				getEditorCfgs : function(e) {
					var t = this, r = t.get("grid"), i = r.get("el").find(
							"." + n), s = [];
					BUI.each(e, function(e) {
						var t = {
							field : e,
				...
				updateRecord : function(e, t, n) {
					var r = this, i = n.getValue(), s = n.get("field").get(
							"name"), o = t[s];
...
define("bui/grid/plugins/rowediting", [ "bui/common",
		"bui/grid/plugins/editing" ], function(e) {
	var t = e("bui/common"), n = e("bui/grid/plugins/editing"), r = t.prefix
			+ "grid-row", i = function(e) {
		i.superclass.constructor.call(this, e)
	};
	i.ATTRS = {
		align : {
	...
	t.augment(i, {
		...
		wrapValidator : function(e) {
			var t = this;
			return function(n) {
				var r = t.get("curEditor"), i = r ? r.getValue() : t
						.get("record");
				if (i)
					return e(n, i)
			}
		...
		getFieldConfig : function(e) {
			var t = e.get("editor");
			if (t) {
				t.xtype === "checkbox" && (t.innerValueField = "checked");
				return t
			}
			var n = {
				xtype : "plain"
			};
			e.get("dataIndex") && e.get("renderer")
					&& (n.renderer = e.get("renderer"));
			return n
		},
		...
		onColumnVisibleChange : function(e) {
			var t = this, n = e.get("id"), r = t.getEditor(), i = r.getChild(n,
					!0);
			i && i.set("visible", e.get("visible"))
		},
		beforeShowEditor : function(e, n) {
			var r = this, i = r.get("grid"), s = i.get("columns"), o = e
					.get("form"), u = $(n.row);
			e.set("width", u.width());
			t.each(s, function(e) {
				if (!e.get("visible"))
					...
					var t = e.get("dataIndex"), n = o.getField(t), r = e.get(
							"el").outerWidth()
							- n.getAppendWidth();
					n.set("width", r)
				}
					...
					.augment(
							i,
							{
								...
								_initEditor : function(e) {
									var n = this, r = n.get("contentId"), i = $(
											"#" + r).find("form"), s = n
											.get("editor"), o = t.merge(s, {
										contentId : r,
										form : {
											srcNode : i
										}
								...
								saveRecord : function(e) {
									var r = this, i = r.get("grid"), s = r
											.get("editType"), o = r
											.get("curIndex"), u = i
											.get("store"), a = r.get("record");
									t.mix(a, e);
									s == n ? o != null ? u.addAt(a, o) : u
											.add(a) : u.update(a)
								},
...
define(
		...
		function(e) {
			...
			var r = e("bui/common"), i = e("bui/data"), s = "expanded", o = "loading", u = "checked", a = "partial-checked", f = {
				...
				CUSTOM : "custom",
				ONLY_LEAF : "onlyLeaf"
			}, l = "x-tree-icon", c = "x-tree-elbow", h = "x-tree-show-line", p = c
					+ "-", d = l + "-wraper", v = p + "line", m = p + "end", g = p
					+ "empty", y = p + "expander", b = l + "-checkbox", w = y
					+ "-end", E = function() {
			};
			E.ATTRS = {
				store : {
					getter : function(e) {
						if (!e) {
							var t = this, n = new i.TreeStore({
								root : t.get("root"),
								data : t.get("nodes")
							});
							t.setInternal("store", n);
							return n
						}
						return e
					}
					...
					.augment(
							E,
							{
								...
								expandNode : function(e, t) {
									...
									e.parent && !n.isExpanded(e.parent)
								...
								expandPath : function(e, t, n) {
									if (!e)
										return;
									n = n || 0;
									var r = this, i = r.get("store"), s, o, u, a, f = e
											.split(",");
									s = r.findNode(f[n]);
								...
								isExpanded : function(e) {
									if (!e || e.leaf)
										return !1;
									var t = this, n;
									if (t._isRoot(e) && !t.get("showRoot"))
										return !0;
									r.isString(e) && (item = t.getItem(e));
									n = t.findElement(e);
									return this._isExpanded(e, n)
								},
								...
								setNodeChecked : function(e, n, i) {
									...
									if (!s.isCheckable(e))
										return;
									if (s.isChecked(e) !== n
											|| s.hasStatus(e, "checked") !== n) {
										a = s.findElement(e);
										if (a) {
											s.setItemStatus(e, u, n, a);
											s._resetPatialChecked(e, n, n, a)
										} else
											s.isItemDisabled(e)
													|| s.setStatusValue(e,
															"checked", n);
								...
								_initRoot : function() {
									var e = this, t = e.get("store"), n, i = e
											.get("showRoot"), s;
									if (t) {
										n = t.get("root");
										e.setInternal("root", n);
										i ? s = [ n ] : s = n.children;
										r.each(s, function(t) {
											e._initChecked(t, !0)
										});
								...
								_initChecked : function(e, t) {
									var n = this, i = n.get("checkType"), s = n
											.get("checkedField"), o;
									if (i === f.NONE) {
										delete e[s];
										return
									...
									if (!n.isChecked(e)) {
										...
										e.children
												&& e.children.length
												&& n._isAllChildrenChecked(e)
												&& n.setStatusValue(e,
														"checked", !0)
									}
									t && r.each(e.children, function(e) {
										n._initChecked(e, t)
									})
								},
								...
								_initExpandEvent : function() {
									...
									var e = this, t = e.get("el"), n = e
											...
											.get("collapseEvent");
									if (n == r)
										e.on(n, i("_toggleExpand"));
									else {
										n && e.on(n, i("_expandNode"));
										r && e.on(r, i("_collapseNode"))
									}
								},
								...
								_beforeLoadNode : function(e) {
									...
									r.isString(e) && (e = t.findNode(e));
									n = t.findElement(e);
									n && t._setLoadStatus(e, n, !0);
									e && r.each(e.children, function(e) {
										t._removeNode(e)
									})
								},
								onBeforeLoad : function(e) {
									var t = this, n = e.params, r = n.id, i = t
											.findNode(r)
											|| t.get("root");
									t._beforeLoadNode(i)
								},
								...
								_getNextItem : function(e) {
									...
									if (!n)
										return null;
									i = n.children;
									s = r.Array.indexOf(e, i);
									o = i[s + 1];
									return o || t._getNextItem(n)
								},
								onAdd : function(e) {
								...
								_loadNode : function(e) {
									...
									t.expandNode(e);
									t._updateIcons(e);
									t.setItemStatus(e, o, !1)
								},
								__syncUI : function() {
									var e = this, t = e.get("store"), n = e
											.get("showRoot");
									n && !t.hasData() && e._initRoot()
								},
								onLoad : function(e) {
									var t = this, n = t.get("store"), r = n
											.get("root"), i;
									(!e || e.node == r) && t._initRoot();
								...
								_getIconsTpl : function(e) {
									var t = this, n = e.level, i = t
											.get("startLevel"), s = t
											.get("iconWraperTpl"), o = [], u;
									for (u = i; u < n; u += 1)
										o.push(t._getLevelIcon(e, u));
									o.push(t._getExpandIcon(e));
								...
								_getExpandIcon : function(e) {
									var t = this, n = y;
									if (e.leaf)
										return t._getLevelIcon(e);
									t._isLastNode(e) && (n = n + " " + w);
									return t._getIcon(n)
								},
								_getNodeTypeIcon : function(e) {
									var t = this, n = e.cls ? e.cls
											: e.leaf ? t.get("leafCls") : t
													.get("dirCls");
									return t._getIcon(n)
								},
								_getLevelIcon : function(e, t) {
									...
									if (r)
										if (e.level === t || t == null)
											i = n._isLastNode(e) ? m : c;
										else {
											s = n._getParentNode(e, t);
											i = n._isLastNode(s) ? g : v
										}
									return n._getIcon(i)
								},
								...
								_isLastNode : function(e) {
									...
									if (e == this.get("root"))
										return !0;
									var t = this, n = e.parent, r = n ? n.children
											: t.get("nodes"), i;
									i = r.length;
									return r[i - 1] === e
								},
								_initNodes : function(e, t, n) {
									...
									r.each(e, function(e) {
										...
										e.leaf == null
												&& (e.leaf = e.children ? !1
														: !0);
										n && !e.parent && (e.parent = n);
										i._initChecked(e);
										e.children
												&& i._initNodes(e.children,
														t + 1, e)
									})
								},
								_collapseNode : function(e, t, n) {
									...
									if (e.leaf)
										return;
									if (r.hasStatus(e, s, t)) {
										r.setItemStatus(e, s, !1, t);
										if (n) {
											r._collapseChildren(e, n);
											r.removeItems(e.children)
										} else
											r._hideChildrenNodes(e);
										r.fire("collapsed", {
											node : e,
											element : t
										})
								...
								_expandNode : function(e, t, n) {
									var i = this, o = i.get("accordion"), u = i
											.get("store");
									if (e.leaf)
										return;
									if (!i.hasStatus(e, s, t)) {
										...
										if (u && !u.isLoaded(e))
											i._isLoading(e, t) || u.loadNode(e);
										else if (t) {
											i.setItemStatus(e, s, !0, t);
											i._showChildren(e);
											i.fire("expanded", {
												node : e,
												element : t
								...
								_resetIcons : function(e, t) {
									if (!this.get("showIcons"))
										return;
									var n = this, r = n.get("iconContainer"), i, s = n
											._getIconsTpl(e);
									$(t).find("." + d).remove();
									i = $(t).find(r).first();
									r && i.length ? $(s).prependTo(i) : $(t)
											.prepend($(s))
								},
								_toggleExpand : function(e, t) {
									var n = this;
									n._isExpanded(e, t) ? n._collapseNode(e, t)
											: n._expandNode(e, t)
								},
								...
								_uiSetShowRoot : function(e) {
									var t = this, n = this.get("showRoot") ? 0
											: 1;
									t.set("startLevel", n)
								},
...
define(
		"bui/tree/treelist",
		[ "bui/common", "bui/list", "bui/tree/treemixin" ],
		function(e) {
			var t = e("bui/common"), n = e("bui/list"), r = e("bui/tree/treemixin"), i = n.SimpleList
					.extend([ r ], {}, {
						ATTRS : {
							itemCls : {
...
define(
		"bui/tooltip",
		[ "bui/common", "bui/tooltip/tip", "bui/tooltip/tips" ],
		function(e) {
	...
	var t = e("bui/common"), n = e("bui/overlay"), r = "x-align-", i = {
		...
		"bottom-right" : [ "br", "tr" ]
	}, o = n.OverlayView.extend(
			{
				...
				_uiSetTitle : function(e) {
					var n = this, r = n.get("titleTpl"), i = n
							._getTitleContainer(), s = n.get("titleEl"), o;
					s && s.remove();
					e = e || "";
					t.isString(e) && (e = {
						title : e
...
define("bui/tooltip/tips", [ "bui/common", "bui/tooltip/tip" ], function(e) {
	...
	n.augment(i, {
		...
		_setTitle : function(e, r) {
			var i = this, s = e.attr("data-title"), o = e.attr("data-align")
					|| i.get("defaultAlignType");
...
BUI.use([ "bui/common", "bui/data", "bui/list", "bui/picker", "bui/menu",
		"bui/toolbar", "bui/progressbar", "bui/cookie", "bui/form", "bui/mask",
		"bui/select", "bui/tab", "bui/calendar", "bui/overlay", "bui/editor",
		"bui/grid", "bui/tree", "bui/tooltip" ]);